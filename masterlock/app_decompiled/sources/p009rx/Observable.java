...
import p009rx.functions.Func4;
import p009rx.functions.Func5;
import p009rx.functions.Func6;
import p009rx.functions.Func7;
import p009rx.functions.Func8;
import p009rx.functions.Func9;
import p009rx.functions.FuncN;
import p009rx.functions.Functions;
import p009rx.internal.observers.AssertableSubscriberObservable;
import p009rx.internal.operators.CachedObservable;
import p009rx.internal.operators.EmptyObservableHolder;
import p009rx.internal.operators.NeverObservableHolder;
import p009rx.internal.operators.OnSubscribeAmb;
import p009rx.internal.operators.OnSubscribeCollect;
import p009rx.internal.operators.OnSubscribeCombineLatest;
import p009rx.internal.operators.OnSubscribeConcatMap;
import p009rx.internal.operators.OnSubscribeCreate;
import p009rx.internal.operators.OnSubscribeDefer;
import p009rx.internal.operators.OnSubscribeDelaySubscription;
import p009rx.internal.operators.OnSubscribeDelaySubscriptionOther;
import p009rx.internal.operators.OnSubscribeDelaySubscriptionWithSelector;
import p009rx.internal.operators.OnSubscribeDetach;
import p009rx.internal.operators.OnSubscribeDoOnEach;
import p009rx.internal.operators.OnSubscribeFilter;
import p009rx.internal.operators.OnSubscribeFlatMapCompletable;
import p009rx.internal.operators.OnSubscribeFlatMapSingle;
import p009rx.internal.operators.OnSubscribeFlattenIterable;
import p009rx.internal.operators.OnSubscribeFromArray;
import p009rx.internal.operators.OnSubscribeFromCallable;
import p009rx.internal.operators.OnSubscribeFromIterable;
import p009rx.internal.operators.OnSubscribeGroupJoin;
import p009rx.internal.operators.OnSubscribeJoin;
import p009rx.internal.operators.OnSubscribeLift;
import p009rx.internal.operators.OnSubscribeMap;
import p009rx.internal.operators.OnSubscribeRange;
import p009rx.internal.operators.OnSubscribeRedo;
import p009rx.internal.operators.OnSubscribeReduce;
import p009rx.internal.operators.OnSubscribeReduceSeed;
import p009rx.internal.operators.OnSubscribeSingle;
import p009rx.internal.operators.OnSubscribeSkipTimed;
import p009rx.internal.operators.OnSubscribeSwitchIfEmpty;
import p009rx.internal.operators.OnSubscribeTakeLastOne;
import p009rx.internal.operators.OnSubscribeThrow;
import p009rx.internal.operators.OnSubscribeTimeoutSelectorWithFallback;
import p009rx.internal.operators.OnSubscribeTimeoutTimedWithFallback;
import p009rx.internal.operators.OnSubscribeTimerOnce;
import p009rx.internal.operators.OnSubscribeTimerPeriodically;
import p009rx.internal.operators.OnSubscribeToMap;
import p009rx.internal.operators.OnSubscribeToMultimap;
import p009rx.internal.operators.OnSubscribeToObservableFuture;
import p009rx.internal.operators.OnSubscribeUsing;
import p009rx.internal.operators.OperatorAll;
import p009rx.internal.operators.OperatorAny;
import p009rx.internal.operators.OperatorAsObservable;
import p009rx.internal.operators.OperatorBufferWithSingleObservable;
import p009rx.internal.operators.OperatorBufferWithSize;
import p009rx.internal.operators.OperatorBufferWithStartEndObservable;
import p009rx.internal.operators.OperatorBufferWithTime;
import p009rx.internal.operators.OperatorCast;
import p009rx.internal.operators.OperatorDebounceWithSelector;
import p009rx.internal.operators.OperatorDebounceWithTime;
import p009rx.internal.operators.OperatorDelay;
import p009rx.internal.operators.OperatorDelayWithSelector;
import p009rx.internal.operators.OperatorDematerialize;
import p009rx.internal.operators.OperatorDistinct;
import p009rx.internal.operators.OperatorDistinctUntilChanged;
import p009rx.internal.operators.OperatorDoAfterTerminate;
import p009rx.internal.operators.OperatorDoOnRequest;
import p009rx.internal.operators.OperatorDoOnSubscribe;
import p009rx.internal.operators.OperatorDoOnUnsubscribe;
import p009rx.internal.operators.OperatorEagerConcatMap;
import p009rx.internal.operators.OperatorElementAt;
import p009rx.internal.operators.OperatorGroupBy;
import p009rx.internal.operators.OperatorGroupByEvicting;
import p009rx.internal.operators.OperatorIgnoreElements;
import p009rx.internal.operators.OperatorMapNotification;
import p009rx.internal.operators.OperatorMapPair;
import p009rx.internal.operators.OperatorMaterialize;
import p009rx.internal.operators.OperatorMerge;
import p009rx.internal.operators.OperatorObserveOn;
import p009rx.internal.operators.OperatorOnBackpressureBuffer;
import p009rx.internal.operators.OperatorOnBackpressureDrop;
import p009rx.internal.operators.OperatorOnBackpressureLatest;
import p009rx.internal.operators.OperatorOnErrorResumeNextViaFunction;
import p009rx.internal.operators.OperatorPublish;
import p009rx.internal.operators.OperatorReplay;
import p009rx.internal.operators.OperatorRetryWithPredicate;
import p009rx.internal.operators.OperatorSampleWithObservable;
import p009rx.internal.operators.OperatorSampleWithTime;
import p009rx.internal.operators.OperatorScan;
import p009rx.internal.operators.OperatorSequenceEqual;
import p009rx.internal.operators.OperatorSerialize;
import p009rx.internal.operators.OperatorSingle;
import p009rx.internal.operators.OperatorSkip;
import p009rx.internal.operators.OperatorSkipLast;
import p009rx.internal.operators.OperatorSkipLastTimed;
import p009rx.internal.operators.OperatorSkipUntil;
import p009rx.internal.operators.OperatorSkipWhile;
import p009rx.internal.operators.OperatorSubscribeOn;
import p009rx.internal.operators.OperatorSwitch;
import p009rx.internal.operators.OperatorTake;
import p009rx.internal.operators.OperatorTakeLast;
import p009rx.internal.operators.OperatorTakeLastTimed;
import p009rx.internal.operators.OperatorTakeTimed;
import p009rx.internal.operators.OperatorTakeUntil;
import p009rx.internal.operators.OperatorTakeUntilPredicate;
import p009rx.internal.operators.OperatorTakeWhile;
import p009rx.internal.operators.OperatorThrottleFirst;
import p009rx.internal.operators.OperatorTimeInterval;
import p009rx.internal.operators.OperatorTimestamp;
import p009rx.internal.operators.OperatorToObservableList;
import p009rx.internal.operators.OperatorToObservableSortedList;
import p009rx.internal.operators.OperatorUnsubscribeOn;
import p009rx.internal.operators.OperatorWindowWithObservable;
import p009rx.internal.operators.OperatorWindowWithObservableFactory;
import p009rx.internal.operators.OperatorWindowWithSize;
import p009rx.internal.operators.OperatorWindowWithStartEndObservable;
import p009rx.internal.operators.OperatorWindowWithTime;
import p009rx.internal.operators.OperatorWithLatestFrom;
import p009rx.internal.operators.OperatorWithLatestFromMany;
import p009rx.internal.operators.OperatorZip;
import p009rx.internal.operators.OperatorZipIterable;
import p009rx.internal.util.ActionNotificationObserver;
import p009rx.internal.util.ActionObserver;
import p009rx.internal.util.ActionSubscriber;
import p009rx.internal.util.InternalObservableUtils;
import p009rx.internal.util.ObserverSubscriber;
...
import p009rx.observables.AsyncOnSubscribe;
import p009rx.observables.BlockingObservable;
import p009rx.observables.ConnectableObservable;
import p009rx.observables.GroupedObservable;
import p009rx.observables.SyncOnSubscribe;
import p009rx.observers.AssertableSubscriber;
import p009rx.observers.SafeSubscriber;
...
public class Observable<T> {
    ...
    /* renamed from: to */
    public final <R> R mo25043to(Func1<? super Observable<T>, R> func1) {
        return func1.call(this);
    }

    public Single<T> toSingle() {
        return new Single<>((p009rx.Single.OnSubscribe<T>) OnSubscribeSingle.create(this));
    }

...
public final class OperatorBufferWithStartEndObservable<T, TOpening, TClosing> implements Operator<List<T>, T> {
    ...
    final class BufferingSubscriber extends Subscriber<T> {
        ...
        public void onCompleted() {
            ...
            L_0x0039:
                ...
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: p009rx.internal.operators.OperatorBufferWithStartEndObservable.BufferingSubscriber.onCompleted():void");
        }
            ...
            synchronized (this) {
                if (!this.done) {
                    ...
                    try {
                        ...
                        C20591 r1 = new Subscriber<TClosing>() {
        ...
        public void endBuffer(java.util.List<T> r3) {
            ...
            L_0x002a:
                ...
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: p009rx.internal.operators.OperatorBufferWithStartEndObservable.BufferingSubscriber.endBuffer(java.util.List):void");
        }
    }
    ...
    public Subscriber<? super T> call(Subscriber<? super List<T>> subscriber) {
        ...
        C20581 r1 = new Subscriber<TOpening>() {

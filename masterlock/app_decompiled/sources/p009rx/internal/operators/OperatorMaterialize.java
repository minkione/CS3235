...
public final class OperatorMaterialize<T> implements Operator<Notification<T>, T> {
    ...
    static class ParentSubscriber<T> extends Subscriber<T> {
        ...
        /* JADX WARNING: Code restructure failed: missing block: B:17:0x0033, code lost:
            if (r7.child.isUnsubscribed() != false) goto L_0x003a;
         */
        ...
        private void drain() {
            ...
            L_0x004b:
                ...
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: p009rx.internal.operators.OperatorMaterialize.ParentSubscriber.drain():void");
        }
    }

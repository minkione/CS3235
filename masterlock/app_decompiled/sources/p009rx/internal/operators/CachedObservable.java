...
import p009rx.internal.util.LinkedArrayList;
...
public final class CachedObservable<T> extends Observable<T> {
    ...
    static final class ReplayProducer<T> extends AtomicLong implements Producer, Subscription {
        ...
        /* JADX WARNING: Code restructure failed: missing block: B:23:0x003f, code lost:
            if (p009rx.internal.operators.NotificationLite.isCompleted(r3) == false) goto L_0x004d;
         */
        ...
        /* JADX WARNING: Code restructure failed: missing block: B:32:0x0051, code lost:
            if (p009rx.internal.operators.NotificationLite.isError(r3) == false) goto L_0x00c5;
         */
        /* JADX WARNING: Code restructure failed: missing block: B:33:0x0053, code lost:
            r2.onError(p009rx.internal.operators.NotificationLite.getError(r3));
         */
        ...
        /* JADX WARNING: Code restructure failed: missing block: B:52:0x007f, code lost:
            if (p009rx.internal.operators.NotificationLite.accept(r2, r13) == false) goto L_0x0088;
         */
        ...
        /* JADX WARNING: Code restructure failed: missing block: B:62:?, code lost:
            p009rx.exceptions.Exceptions.throwIfFatal(r3);
         */
        /* JADX WARNING: Code restructure failed: missing block: B:64:?, code lost:
            unsubscribe();
         */
        /* JADX WARNING: Code restructure failed: missing block: B:68:0x00a6, code lost:
            r2.onError(p009rx.exceptions.OnErrorThrowable.addValueAsLastCause(r3, p009rx.internal.operators.NotificationLite.getValue(r13)));
         */
        /* JADX WARNING: Code restructure failed: missing block: B:69:0x00b1, code lost:
            return;
         */
        /* JADX WARNING: Code restructure failed: missing block: B:70:0x00b2, code lost:
            r1 = th;
         */
        ...
        /* JADX WARNING: Code restructure failed: missing block: B:74:0x00ba, code lost:
            return;
         */
        /* JADX WARNING: Code restructure failed: missing block: B:75:0x00bb, code lost:
            r15.index = r10;
        ...
        /* JADX WARNING: Code restructure failed: missing block: B:87:0x00d3, code lost:
            r2 = th;
         */
        /* JADX WARNING: Code restructure failed: missing block: B:88:0x00d4, code lost:
            r1 = false;
         */
        ...
        /* JADX WARNING: Code restructure failed: missing block: B:94:0x00d8, code lost:
            ...
            r1 = r2;
         */
        /* JADX WARNING: Code restructure failed: missing block: B:95:0x00db, code lost:
            r2 = th;
         */
        /* JADX WARNING: Code restructure failed: missing block: B:96:0x00dd, code lost:
            r1 = th;
         */
        ...
        public void replay() {
            ...
            L_0x002f:
                ...
                boolean r4 = p009rx.internal.operators.NotificationLite.isCompleted(r3)     // Catch:{ all -> 0x00dd }
            ...
            L_0x0048:
                ...
                goto L_0x00df
            L_0x004d:
                boolean r4 = p009rx.internal.operators.NotificationLite.isError(r3)     // Catch:{ all -> 0x00dd }
                if (r4 == 0) goto L_0x00c5
                java.lang.Throwable r3 = p009rx.internal.operators.NotificationLite.getError(r3)     // Catch:{ all -> 0x00dd }
            ...
            L_0x0079:
                ...
                boolean r14 = p009rx.internal.operators.NotificationLite.accept(r2, r13)     // Catch:{ Throwable -> 0x0092 }
                if (r14 == 0) goto L_0x0088
                r15.unsubscribe()     // Catch:{ Throwable -> 0x0085 }
                return
            L_0x0085:
                r3 = move-exception
                r4 = 1
            ...
            L_0x0092:
                ...
                r4 = 0
            L_0x0094:
                p009rx.exceptions.Exceptions.throwIfFatal(r3)     // Catch:{ all -> 0x00b2 }
                r15.unsubscribe()     // Catch:{ all -> 0x0048 }
                boolean r4 = p009rx.internal.operators.NotificationLite.isError(r13)     // Catch:{ all -> 0x0048 }
                if (r4 != 0) goto L_0x00b1
                boolean r4 = p009rx.internal.operators.NotificationLite.isCompleted(r13)     // Catch:{ all -> 0x0048 }
                if (r4 != 0) goto L_0x00b1
                java.lang.Object r4 = p009rx.internal.operators.NotificationLite.getValue(r13)     // Catch:{ all -> 0x0048 }
                java.lang.Throwable r3 = p009rx.exceptions.OnErrorThrowable.addValueAsLastCause(r3, r4)     // Catch:{ all -> 0x0048 }
            ...
            L_0x00ea:
                ...
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: p009rx.internal.operators.CachedObservable.ReplayProducer.replay():void");
        }
    }

...
public final class OperatorBufferWithSingleObservable<T, TClosing> implements Operator<List<T>, T> {
    ...
    final class BufferingSubscriber extends Subscriber<T> {
        ...
        /* JADX WARNING: Code restructure failed: missing block: B:20:0x002a, code lost:
            p009rx.exceptions.Exceptions.throwOrReport(r0, (p009rx.Observer<?>) r3.child);
         */
        ...
        public void emit() {
            ...
            L_0x0007:
                ...
                rx.internal.operators.OperatorBufferWithSingleObservable r2 = p009rx.internal.operators.OperatorBufferWithSingleObservable.this     // Catch:{ all -> 0x0033 }
                int r2 = r2.initialCapacity     // Catch:{ all -> 0x0033 }
                r1.<init>(r2)     // Catch:{ all -> 0x0033 }
                r3.chunk = r1     // Catch:{ all -> 0x0033 }
                monitor-exit(r3)     // Catch:{ all -> 0x0033 }
                rx.Subscriber<? super java.util.List<T>> r1 = r3.child     // Catch:{ Throwable -> 0x001b }
                r1.onNext(r0)     // Catch:{ Throwable -> 0x001b }
                goto L_0x002f
            L_0x001b:
                r0 = move-exception
                r3.unsubscribe()
            ...
            L_0x0033:
                ...
                throw r0
            */
            throw new UnsupportedOperationException("Method not decompiled: p009rx.internal.operators.OperatorBufferWithSingleObservable.BufferingSubscriber.emit():void");
        }
    }
    ...
    public Subscriber<? super T> call(Subscriber<? super List<T>> subscriber) {
        try {
            ...
            C20562 r2 = new Subscriber<TClosing>() {

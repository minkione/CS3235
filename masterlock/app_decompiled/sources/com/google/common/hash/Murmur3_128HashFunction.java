...
final class Murmur3_128HashFunction extends AbstractStreamingHashFunction implements Serializable {
    ...
    private static final class Murmur3_128Hasher extends AbstractStreamingHasher {
        ...
        /* renamed from: C1 */
        private static final long f122C1 = -8663945395140668459L;

        /* renamed from: C2 */
        private static final long f123C2 = 5545529020109919103L;
        ...
        private void bmix64(long j, long j2) {
            this.f124h1 = mixK1(j) ^ this.f124h1;
            this.f124h1 = Long.rotateLeft(this.f124h1, 27);
            long j3 = this.f124h1;
            long j4 = this.f125h2;
            this.f124h1 = j3 + j4;
            this.f124h1 = (this.f124h1 * 5) + 1390208809;
            this.f125h2 = mixK2(j2) ^ j4;
            this.f125h2 = Long.rotateLeft(this.f125h2, 31);
            this.f125h2 += this.f124h1;
            this.f125h2 = (this.f125h2 * 5) + 944331445;
        }
        ...
        /* JADX WARNING: Code restructure failed: missing block: B:32:0x00f6, code lost:
            r11.f124h1 = mixK1(r2) ^ r11.f124h1;
            r11.f125h2 = mixK2(r0) ^ r11.f125h2;
         */
        ...
        public HashCode makeHash() {
            ...
            long j4 = this.f124h1;
            this.f125h2 = j3 + j4;
            this.f124h1 = fmix64(j4);
            this.f125h2 = fmix64(this.f125h2);
            long j5 = this.f124h1;
            long j6 = this.f125h2;
            this.f124h1 = j5 + j6;
            this.f125h2 = j6 + this.f124h1;
            return HashCode.fromBytesNoCopy(ByteBuffer.wrap(new byte[16]).order(ByteOrder.LITTLE_ENDIAN).putLong(this.f124h1).putLong(this.f125h2).array());
        }

        private static long mixK1(long j) {
            return Long.rotateLeft(j * f122C1, 31) * f123C2;
        }

        private static long mixK2(long j) {
            return Long.rotateLeft(j * f123C2, 33) * f122C1;
        }
    }

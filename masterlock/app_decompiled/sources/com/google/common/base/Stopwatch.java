...
public final class Stopwatch {
    ...
    static /* synthetic */ class C05221 {
        ...
        static {
            ...
            L_0x0056:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.google.common.base.Stopwatch.C05221.<clinit>():void");
        }
    }
    ...
    public String toString() {
        ...
        return String.format("%.4g %s", new Object[]{Double.valueOf(d / convert), abbreviate(chooseUnit)});
    }
    ...
    private static String abbreviate(TimeUnit timeUnit) {
        switch (C05221.$SwitchMap$java$util$concurrent$TimeUnit[timeUnit.ordinal()]) {
            case 1:
                return "ns";
            case 2:
                return "μs";

...
public abstract class ImmutableMap<K, V> implements Map<K, V>, Serializable {
    ...
    public static class Builder<K, V> {
        ...
        private void ensureCapacity(int i) {
            ...
            if (i > terminalEntryArr.length) {
                this.entries = (TerminalEntry[]) ObjectArrays.arraysCopyOf(terminalEntryArr, com.google.common.collect.ImmutableCollection.Builder.expandedCapacity(terminalEntryArr.length, i));
            }
        }
        ...
        public ImmutableMap<K, V> build() {
            ...
            switch (i) {
                ...
                case 1:
                    return ImmutableMap.m85of(this.entries[0].getKey(), this.entries[0].getValue());
                default:
    ...
    private static final class MapViewOfValuesAsSingletonSets<K, V> extends ImmutableMap<K, ImmutableSet<V>> {
        ...
        public ImmutableSet<V> get(@Nullable Object obj) {
            ...
            return ImmutableSet.m108of(obj2);
        }
                        ...
                        public Entry<K, ImmutableSet<V>> next() {
                            ...
                            return new AbstractMapEntry<K, ImmutableSet<V>>() {
                                ...
                                public ImmutableSet<V> getValue() {
                                    return ImmutableSet.m108of(entry.getValue());
                                }
                            };
                        }
                    };
    ...
    /* renamed from: of */
    public static <K, V> ImmutableMap<K, V> m84of() {
        return ImmutableBiMap.m59of();
    }

    /* renamed from: of */
    public static <K, V> ImmutableMap<K, V> m85of(K k, V v) {
        return ImmutableBiMap.m60of(k, v);
    }

    /* renamed from: of */
    public static <K, V> ImmutableMap<K, V> m86of(K k, V v, K k2, V v2) {
        return new RegularImmutableMap((TerminalEntry<?, ?>[]) new TerminalEntry[]{entryOf(k, v), entryOf(k2, v2)});
    }

    /* renamed from: of */
    public static <K, V> ImmutableMap<K, V> m87of(K k, V v, K k2, V v2, K k3, V v3) {
        return new RegularImmutableMap((TerminalEntry<?, ?>[]) new TerminalEntry[]{entryOf(k, v), entryOf(k2, v2), entryOf(k3, v3)});
    }

    /* renamed from: of */
    public static <K, V> ImmutableMap<K, V> m88of(K k, V v, K k2, V v2, K k3, V v3, K k4, V v4) {
        return new RegularImmutableMap((TerminalEntry<?, ?>[]) new TerminalEntry[]{entryOf(k, v), entryOf(k2, v2), entryOf(k3, v3), entryOf(k4, v4)});
    }

    /* renamed from: of */
    public static <K, V> ImmutableMap<K, V> m89of(K k, V v, K k2, V v2, K k3, V v3, K k4, V v4, K k5, V v5) {
    ...
    public static <K, V> ImmutableMap<K, V> copyOf(Map<? extends K, ? extends V> map) {
        ...
        switch (entryArr.length) {
            ...
            case 1:
                ...
                return m85of(entry.getKey(), entry.getValue());
            default:

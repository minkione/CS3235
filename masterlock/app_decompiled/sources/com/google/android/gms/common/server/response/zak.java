...
public final class zak extends AbstractSafeParcelable {
    ...
    @SafeParcelable.Field(getter = "getSerializedDictionary", mo9239id = 2)
    private final ArrayList<zal> zaqv;
    @SafeParcelable.Field(getter = "getRootClassName", mo9239id = 3)
    private final String zaqw;

    @Constructor
    zak(@Param(mo9242id = 1) int i, @Param(mo9242id = 2) ArrayList<zal> arrayList, @Param(mo9242id = 3) String str) {
        this.zale = i;
        this.zaqv = null;

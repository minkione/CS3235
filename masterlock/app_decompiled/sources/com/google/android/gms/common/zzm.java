...
class zzm {
    ...
    static String zza(String str, zze zze, boolean z, boolean z2) {
        return String.format("%s: pkg=%s, sha1=%s, atk=%s, ver=%s", new Object[]{z2 ? "debug cert rejected" : "not whitelisted", str, Hex.zza(AndroidUtilsLight.zzi(CommonUtils.SHA1_INSTANCE).digest(zze.getBytes())), Boolean.valueOf(z), "12451009.false"});
    }
}

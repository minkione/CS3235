...
public class GeofencingRequest extends AbstractSafeParcelable {
    ...
    @Field(getter = "getParcelableGeofences", mo9239id = 1)
    private final List<zzbh> zzap;
    @Field(getter = "getInitialTrigger", mo9239id = 2)
    ...
    @Constructor
    GeofencingRequest(@Param(mo9242id = 1) List<zzbh> list, @Param(mo9242id = 2) int i, @Param(mo9242id = 3) String str) {
        this.zzap = list;
        this.zzaq = i;
        this.tag = str;
    }

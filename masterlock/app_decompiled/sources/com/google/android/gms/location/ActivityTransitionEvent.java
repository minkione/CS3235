...
public class ActivityTransitionEvent extends AbstractSafeParcelable {
    ...
    @Field(getter = "getActivityType", mo9239id = 1)
    private final int zzi;
    @Field(getter = "getTransitionType", mo9239id = 2)
    private final int zzj;
    @Field(getter = "getElapsedRealTimeNanos", mo9239id = 3)
    private final long zzk;

    @Constructor
    public ActivityTransitionEvent(@Param(mo9242id = 1) int i, @Param(mo9242id = 2) int i2, @Param(mo9242id = 3) long j) {

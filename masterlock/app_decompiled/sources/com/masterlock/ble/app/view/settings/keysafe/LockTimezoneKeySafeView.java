...
public class LockTimezoneKeySafeView extends LinearLayout implements IAuthenticatedView {
    @InjectView(2131296597)
    TextView mLockNameBanner;
    private LockTimezoneKeySafePresenter mLockNamePresenter;
    ...
    public LockTimezoneKeySafeView(Context context) {
        this(context, null);
    }

    public LockTimezoneKeySafeView(Context context, AttributeSet attributeSet) {
    ...
    public void onAttachedToWindow() {
        ...
        if (!isInEditMode()) {
            ...
            this.mLockNamePresenter = new LockTimezoneKeySafePresenter(this);

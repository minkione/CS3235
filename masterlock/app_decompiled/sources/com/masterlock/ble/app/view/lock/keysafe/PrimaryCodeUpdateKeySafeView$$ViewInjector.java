...
public class PrimaryCodeUpdateKeySafeView$$ViewInjector {
    public static void reset(PrimaryCodeUpdateKeySafeView primaryCodeUpdateKeySafeView) {
    }

    public static void inject(Finder finder, final PrimaryCodeUpdateKeySafeView primaryCodeUpdateKeySafeView, Object obj) {
        finder.findRequiredView(obj, C1075R.C1077id.btn_save_code, "method 'savePrimaryCode'").setOnClickListener(new OnClickListener() {
            public void onClick(View view) {
                primaryCodeUpdateKeySafeView.savePrimaryCode();
            }
        });
        finder.findRequiredView(obj, C1075R.C1077id.d_pad_button_1, "method 'onDPadButtonClicked'").setOnClickListener(new OnClickListener() {
            public void onClick(View view) {
                primaryCodeUpdateKeySafeView.onDPadButtonClicked(view);
            }
        });
        ...
        finder.findRequiredView(obj, C1075R.C1077id.primary_code_delete_button, "method 'deleteCodeEntry'").setOnClickListener(new OnClickListener() {
            public void onClick(View view) {
                primaryCodeUpdateKeySafeView.deleteCodeEntry();
            }
        });
    }
}

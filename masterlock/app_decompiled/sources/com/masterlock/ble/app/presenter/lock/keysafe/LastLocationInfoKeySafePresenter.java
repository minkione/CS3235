...
public class LastLocationInfoKeySafePresenter extends AuthenticatedPresenter<Lock, LastLocationInfoKeySafeView> implements OnMapReadyCallback {
    /* access modifiers changed from: private */
    public static final String TAG = "LastLocationInfoKeySafePresenter";
    ...
    public LastLocationInfoKeySafePresenter(Lock lock, LastLocationInfoKeySafeView lastLocationInfoKeySafeView) {
        super(lock, lastLocationInfoKeySafeView);
    }
    ...
    public void start() {
        ...
        ((LastLocationInfoKeySafeView) this.view).showAddress(((Lock) this.model).getLatitude(), ((Lock) this.model).getLongitude());
        getLastLocation();
    }
    ...
    public void getLastLocation() {
        ...
        this.mGetLastLocationSubscription = this.mLockService.getLastLocation((Lock) this.model).subscribeOn(this.mScheduler.background()).observeOn(this.mScheduler.main()).subscribe((Subscriber<? super T>) new Subscriber<LastLocationResponse>() {
            public void onStart() {
                LastLocationInfoKeySafePresenter.this.mEventBus.post(new ToggleProgressBarEvent(true));
            }

            public void onCompleted() {
                LastLocationInfoKeySafePresenter.this.mEventBus.post(new ToggleProgressBarEvent(false));
            }
            ...
            public void onNext(LastLocationResponse lastLocationResponse) {
                LastLocationInfoKeySafePresenter.this.postLastLocation();
                ((LastLocationInfoKeySafeView) LastLocationInfoKeySafePresenter.this.view).updateNotes(lastLocationResponse.notes);
            }
        });
    }

    public void showClearLastLocationDialog() {
        DeleteLastLocationDialog deleteLastLocationDialog = new DeleteLastLocationDialog(((LastLocationInfoKeySafeView) this.view).getContext());
        Dialog dialog = new Dialog(((LastLocationInfoKeySafeView) this.view).getContext());
        ...
        deleteLastLocationDialog.setClearLastLocationButtonClickListener(new OnClickListener(dialog) {
            ...
            public final void onClick(View view) {
                LastLocationInfoKeySafePresenter.lambda$showClearLastLocationDialog$0(LastLocationInfoKeySafePresenter.this, this.f$1, view);
            }
        });
    ...
    public static /* synthetic */ void lambda$showClearLastLocationDialog$0(LastLocationInfoKeySafePresenter lastLocationInfoKeySafePresenter, Dialog dialog, View view) {
        lastLocationInfoKeySafePresenter.clearLastLocation();
        dialog.dismiss();
    }

    public void clearLastLocation() {
        ((LastLocationInfoKeySafeView) this.view).enableClearLocationButton(false);
        this.mUpdateDbSubscription.unsubscribe();
        ...
        this.mUpdateDbSubscription = this.mLockService.updateDb((Lock) this.model).subscribeOn(this.mScheduler.background()).observeOn(this.mScheduler.main()).subscribe((Action1<? super T>) new Action1() {
            public final void call(Object obj) {
                AppFlow.get(((LastLocationInfoKeySafeView) LastLocationInfoKeySafePresenter.this.view).getContext()).goBack();
            }
        }, (Action1<Throwable>) new Action1() {
            public final void call(Object obj) {
                ((LastLocationInfoKeySafeView) LastLocationInfoKeySafePresenter.this.view).enableClearLocationButton(true);
            }
        });
    }
    ...
    public void saveLocationNotes(String str) {
        ...
        this.mSaveLocationNotesSubscription = this.mLockService.postLastLocationNotes((Lock) this.model, str).subscribeOn(this.mScheduler.background()).observeOn(this.mScheduler.main()).subscribe((Subscriber<? super T>) new Subscriber<Void>() {
            ...
            public void onError(Throwable th) {
                Log.e(LastLocationInfoKeySafePresenter.TAG, "onError: ", th);
                LastLocationInfoKeySafePresenter.this.mEventBus.post(new ToggleProgressBarEvent(false));
            }

            public void onNext(Void voidR) {
                if (LastLocationInfoKeySafePresenter.this.view != null) {
                    ((LastLocationInfoKeySafeView) LastLocationInfoKeySafePresenter.this.view).displaySuccess();
                } else {
                    ((LastLocationInfoKeySafeView) LastLocationInfoKeySafePresenter.this.view).displayError(ApiError.generateError(new Throwable("Unable to save notes")));
                }
            }
        });
    }
    ...
    public void showAddress(String str, String str2, Context context) {
        ...
        this.mReverseLocationSubscription = reverseLocation(str, str2, context).subscribeOn(this.mScheduler.background()).observeOn(this.mScheduler.main()).subscribe((Subscriber<? super T>) new Subscriber<String>() {
            ...
            public void onNext(String str) {
                String access$100 = LastLocationInfoKeySafePresenter.TAG;
                StringBuilder sb = new StringBuilder();
                sb.append("onNext: ");
                sb.append(str);
                Log.d(access$100, sb.toString());
                ((LastLocationInfoKeySafeView) LastLocationInfoKeySafePresenter.this.view).updateAddress(str);
            }
        });
    }
    ...
    private Observable<String> reverseLocation(String str, String str2, Context context) {
        return Observable.create((OnSubscribe<T>) new OnSubscribe(str, str2, context) {
            ...
            public final void call(Object obj) {
                LastLocationInfoKeySafePresenter.lambda$reverseLocation$4(this.f$0, this.f$1, this.f$2, (Subscriber) obj);
            }
        });
    }

...
class SessionProtobufHelper {
    ...
    public static void writeSessionDevice(CodedOutputStream codedOutputStream, String str, int i, String str2, int i2, long j, long j2, boolean z, Map<DeviceIdentifierType, String> map, int i3, String str3, String str4) throws Exception {
        ...
        ByteString byteString3 = stringToByteString2;
        ...
        if (byteString4 != null) {
            codedOutputStream2.writeBytes(13, byteString4);
            byteString = byteString3;
        } else {
            byteString = byteString3;
        }
        if (byteString != null) {
            codedOutputStream2.writeBytes(14, byteString);
        }
    }
    ...
    public static void writeSessionEvent(CodedOutputStream codedOutputStream, long j, String str, Throwable th, Thread thread, StackTraceElement[] stackTraceElementArr, Thread[] threadArr, List<StackTraceElement[]> list, Map<String, String> map, LogFileManager logFileManager, RunningAppProcessInfo runningAppProcessInfo, int i, String str2, String str3, float f, int i2, boolean z, long j2, long j3) throws Exception {
        ...
        if (byteStringForLog == null) {
            Fabric.getLogger().mo21793d(CrashlyticsCore.TAG, "No log data to include with this event.");
        }
        logFileManager.clearLog();
        codedOutputStream2.writeTag(10, 2);
        codedOutputStream2.writeRawVarint32(getSessionEventSize(j, str, th, thread, stackTraceElementArr, threadArr, list, 8, map, runningAppProcessInfo, i, copyFromUtf8, byteString2, f, i2, z, j2, j3, byteStringForLog));
        ...
        writeSessionEventApp(codedOutputStream, th, thread, stackTraceElementArr, threadArr, list, 8, copyFromUtf8, byteString2, map, runningAppProcessInfo, i);

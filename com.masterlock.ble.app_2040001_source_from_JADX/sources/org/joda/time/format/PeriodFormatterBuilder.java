...
public class PeriodFormatterBuilder {
                        ...
                        if (isZero(readablePeriod)) {
                            ...
                            if (fieldFormatterArr2[i3] == this) {
                                while (true) {
                                    ...
                                    if (i3 > 9) {
                                        break;
                                    } else if (isSupported(periodType, i3) && this.iFieldFormatters[i3] != null) {
                                        return Long.MAX_VALUE;
                                    }
                                }
                            }
        ...
        public void finish(Set<PeriodFieldAffix> set) {
            ...
            if (this.iOtherAffixes == null) {
                ...
                for (PeriodFieldAffix periodFieldAffix : set) {
                    if (periodFieldAffix != null) {
                        for (String str2 : periodFieldAffix.getAffixes()) {
                            if (str2.length() > i) {
                                hashSet.add(str2);
                            }
                        }
    ...
    static class PluralAffix extends IgnorableAffix {
        ...
        public int parse(String str, int i) {
            ...
            return (!str.regionMatches(true, i, str2, 0, str2.length()) || matchesOtherAffix(str2.length(), str, i)) ? i ^ -1 : i + str2.length();
        }

...
public class DateTimeFormatterBuilder {
    ...
    public DateTimePrinter toPrinter() {
        ...
        if (isPrinter(formatter)) {
            return InternalPrinterDateTimePrinter.m210of((InternalPrinter) formatter);
        }
    ...
    public DateTimeParser toParser() {
        Object formatter = getFormatter();
        if (isParser(formatter)) {
            return InternalParserDateTimeParser.m209of((InternalParser) formatter);
        }
    ...
    public DateTimeFormatterBuilder append(DateTimePrinter dateTimePrinter) {
        ...
        return append0(DateTimePrinterInternalPrinter.m208of(dateTimePrinter), null);
    }

    public DateTimeFormatterBuilder append(DateTimeParser dateTimeParser) {
        checkParser(dateTimeParser);
        return append0(null, DateTimeParserInternalParser.m207of(dateTimeParser));
    }

    public DateTimeFormatterBuilder append(DateTimePrinter dateTimePrinter, DateTimeParser dateTimeParser) {
        checkPrinter(dateTimePrinter);
        checkParser(dateTimeParser);
        return append0(DateTimePrinterInternalPrinter.m208of(dateTimePrinter), DateTimeParserInternalParser.m207of(dateTimeParser));
    }
    ...
    public DateTimeFormatterBuilder append(DateTimePrinter dateTimePrinter, DateTimeParser[] dateTimeParserArr) {
        ...
        if (dateTimeParserArr != null) {
            ...
            if (length != 1) {
                ...
                while (i < length - 1) {
                    InternalParser of = DateTimeParserInternalParser.m207of(dateTimeParserArr[i]);
                ...
                internalParserArr[i] = DateTimeParserInternalParser.m207of(dateTimeParserArr[i]);
                return append0(DateTimePrinterInternalPrinter.m208of(dateTimePrinter), new MatchingParser(internalParserArr));
            } else if (dateTimeParserArr[0] != null) {
                return append0(DateTimePrinterInternalPrinter.m208of(dateTimePrinter), DateTimeParserInternalParser.m207of(dateTimeParserArr[0]));
            } else {
    ...
    public DateTimeFormatterBuilder appendOptional(DateTimeParser dateTimeParser) {
        checkParser(dateTimeParser);
        return append0(null, new MatchingParser(new InternalParser[]{DateTimeParserInternalParser.m207of(dateTimeParser), null}));
    }

...
abstract class BasicChronology extends AssembledChronology {
    ...
    private static final DurationField cWeeksField = new PreciseDurationField(DurationFieldType.weeks(), FirmwareUpdateService.NOTIFY_INTERVAL);
    ...
    public long getDateTimeMillis(int i, int i2, int i3, int i4, int i5, int i6, int i7) throws IllegalArgumentException {
        ...
        return getDateMidnightMillis(i, i2, i3) + ((long) (i4 * DateTimeConstants.MILLIS_PER_HOUR)) + ((long) (i5 * 60000)) + ((long) (i6 * 1000)) + ((long) i7);
    }
    ...
    public int getWeeksInYear(int i) {
        return (int) ((getFirstWeekOfYearMillis(i + 1) - getFirstWeekOfYearMillis(i)) / FirmwareUpdateService.NOTIFY_INTERVAL);
    }
    ...
    public int getWeekyear(long j) {
        ...
        if (weekOfWeekyear == 1) {
            return getYear(j + FirmwareUpdateService.NOTIFY_INTERVAL);
        }
    ...
    public int getWeekOfWeekyear(long j, int i) {
        ...
        return ((int) ((j - firstWeekOfYearMillis) / FirmwareUpdateService.NOTIFY_INTERVAL)) + 1;
    }

...
import p009rx.internal.operators.OnSubscribeOnAssembly;
import p009rx.internal.operators.OnSubscribeOnAssemblyCompletable;
import p009rx.internal.operators.OnSubscribeOnAssemblySingle;
...
public final class RxJavaHooks {
    ...
    static void init() {
        ...
        onCompletableStart = new Func2<Completable, OnSubscribe, OnSubscribe>() {
            public OnSubscribe call(Completable completable, OnSubscribe onSubscribe) {
        ...
        onCompletableLift = new Func1<Operator, Operator>() {
            public Operator call(Operator operator) {
    ...
    public static OnSubscribe onCreate(OnSubscribe onSubscribe) {
        Func1<OnSubscribe, OnSubscribe> func1 = onCompletableCreate;
    ...
    public static <T> OnSubscribe onCompletableStart(Completable completable, OnSubscribe onSubscribe) {
        Func2<Completable, OnSubscribe, OnSubscribe> func2 = onCompletableStart;
    ...
    public static <T, R> Operator onCompletableLift(Operator operator) {
        Func1<Operator, Operator> func1 = onCompletableLift;

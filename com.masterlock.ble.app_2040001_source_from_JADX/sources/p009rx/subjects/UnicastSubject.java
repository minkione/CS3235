...
import p009rx.internal.operators.BackpressureUtils;
import p009rx.internal.operators.NotificationLite;
import p009rx.internal.util.atomic.SpscLinkedAtomicQueue;
import p009rx.internal.util.atomic.SpscUnboundedAtomicArrayQueue;
import p009rx.internal.util.unsafe.SpscLinkedQueue;
...
public final class UnicastSubject<T> extends Subject<T, T> {
    ...
    static final class State<T> extends AtomicLong implements Producer, Observer<T>, OnSubscribe<T>, Subscription {
        ...
        /* JADX WARNING: Code restructure failed: missing block: B:10:0x0011, code lost:
            r3 = (p009rx.Subscriber) r15.subscriber.get();
         */
        ...
        /* JADX WARNING: Code restructure failed: missing block: B:30:0x0055, code lost:
            r12 = p009rx.internal.operators.NotificationLite.getValue(r13);
         */
        ...
        /* JADX WARNING: Code restructure failed: missing block: B:35:0x0062, code lost:
            ...
            r3.onError(p009rx.exceptions.OnErrorThrowable.addValueAsLastCause(r1, r12));
         */
        ...
        public void replay() {
            ...
            L_0x0011:
                ...
                rx.Subscriber r3 = (p009rx.Subscriber) r3
                r4 = 0
            ...
            L_0x0052:
                ...
                goto L_0x0070
            L_0x0055:
                java.lang.Object r12 = p009rx.internal.operators.NotificationLite.getValue(r13)
                r3.onNext(r12)     // Catch:{ Throwable -> 0x0061 }
                r12 = 1
                long r5 = r5 - r12
                long r10 = r10 + r12
                goto L_0x003c
            L_0x0061:
                ...
                r0.clear()
                p009rx.exceptions.Exceptions.throwIfFatal(r1)
                java.lang.Throwable r0 = p009rx.exceptions.OnErrorThrowable.addValueAsLastCause(r1, r12)
                r3.onError(r0)
                return
            L_0x0070:
            ...
            L_0x0097:
                ...
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: p009rx.subjects.UnicastSubject.State.replay():void");
        }

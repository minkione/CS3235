...
import p009rx.internal.operators.CompletableFlatMapSingleToCompletable;
import p009rx.internal.operators.SingleDelay;
import p009rx.internal.operators.SingleDoAfterTerminate;
import p009rx.internal.operators.SingleDoOnEvent;
import p009rx.internal.operators.SingleDoOnSubscribe;
import p009rx.internal.operators.SingleDoOnUnsubscribe;
import p009rx.internal.operators.SingleFromCallable;
import p009rx.internal.operators.SingleFromEmitter;
import p009rx.internal.operators.SingleFromFuture;
import p009rx.internal.operators.SingleFromObservable;
import p009rx.internal.operators.SingleLiftObservableOperator;
import p009rx.internal.operators.SingleObserveOn;
import p009rx.internal.operators.SingleOnErrorReturn;
import p009rx.internal.operators.SingleOnSubscribeDelaySubscriptionOther;
import p009rx.internal.operators.SingleOnSubscribeMap;
import p009rx.internal.operators.SingleOnSubscribeUsing;
import p009rx.internal.operators.SingleOperatorCast;
import p009rx.internal.operators.SingleOperatorOnErrorResumeNext;
import p009rx.internal.operators.SingleOperatorZip;
import p009rx.internal.operators.SingleTakeUntilCompletable;
import p009rx.internal.operators.SingleTakeUntilObservable;
import p009rx.internal.operators.SingleTakeUntilSingle;
import p009rx.internal.operators.SingleTimeout;
import p009rx.internal.operators.SingleToObservable;
import p009rx.internal.util.ScalarSynchronousSingle;
...
import p009rx.singles.BlockingSingle;
...
public class Single<T> {
    ...
    @Deprecated
    protected Single(p009rx.Observable.OnSubscribe<T> onSubscribe2) {
    ...
    public static <T> Single<T> merge(Single<? extends Single<? extends T>> single) {
        ...
        return create(new OnSubscribe<T>(single) {
            ...
            public void call(final SingleSubscriber<? super T> singleSubscriber) {
                C19721 r0 = new SingleSubscriber<Single<? extends T>>() {
        ...
        return create(new OnSubscribe<T>() {
            public void call(final SingleSubscriber<? super T> singleSubscriber) {
                ...
                createWorker.schedule(new Action0() {
                    public void call() {
                        C19611 r0 = new SingleSubscriber<T>() {
                            public void onSuccess(T t) {
                                try {
    ...
    /* renamed from: to */
    public final <R> R mo25135to(Func1<? super Single<T>, R> func1) {
    ...
    public final Single<T> unsubscribeOn(final Scheduler scheduler) {
        return create(new OnSubscribe<T>() {
            public void call(final SingleSubscriber<? super T> singleSubscriber) {
                final C19681 r0 = new SingleSubscriber<T>() {
                    public void onSuccess(T t) {
                        singleSubscriber.onSuccess(t);
                    }

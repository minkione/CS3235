...
import p009rx.internal.util.PlatformDependent;
    ...
    public static boolean tryEnableCancelPolicy(ScheduledExecutorService scheduledExecutorService) {
        ...
        if (SHOULD_TRY_ENABLE_CANCEL_POLICY) {
            if (scheduledExecutorService instanceof ScheduledThreadPoolExecutor) {
                ...
                if (obj2 == null) {
                    Method findSetRemoveOnCancelPolicyMethod = findSetRemoveOnCancelPolicyMethod(scheduledExecutorService);
                    if (findSetRemoveOnCancelPolicyMethod != 0) {
                        obj = findSetRemoveOnCancelPolicyMethod;
                    } else {

    ...
    static final class EagerOuterSubscriber<T, R> extends Subscriber<T> {
        ...
        public void onNext(T r4) {
            /*
                ...
                rx.Observable r0 = (p009rx.Observable) r0     // Catch:{ Throwable -> 0x0032 }
            ...
            L_0x0032:
                ...
                p009rx.exceptions.Exceptions.throwOrReport(r0, r1, r4)
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: p009rx.internal.operators.OperatorEagerConcatMap.EagerOuterSubscriber.onNext(java.lang.Object):void");
        }
        ...
        public void drain() {
            ...
            if (this.wip.getAndIncrement() == 0) {
                ...
                while (!this.cancelled) {
                    ...
                    synchronized (this.subscribers) {
                        eagerInnerSubscriber = (EagerInnerSubscriber) this.subscribers.peek();
                    }
                    boolean z3 = false;
                    ...
                    if (!z4) {
                        ...
                        Queue<Object> queue = eagerInnerSubscriber.queue;
                        long j2 = 0;
                        while (true) {
                            boolean z5 = eagerInnerSubscriber.done;
                            ...
                            if (z5) {
                                Throwable th2 = eagerInnerSubscriber.error;
                                if (th2 == null) {
                                    if (z) {
                                        synchronized (this.subscribers) {
                            ...
                            queue.poll();
                            try {
                                subscriber.onNext(NotificationLite.getValue(peek));
                                j2++;
                                i2 = i;
                            } catch (Throwable th3) {
                                Exceptions.throwOrReport(th3, (Observer<?>) subscriber, peek);
                                return;
                            }
                        }
                        if (j2 != 0) {
                            ...
                            if (!z3) {
                                eagerInnerSubscriber.requestMore(j2);
                            }
                        }
                        if (z3) {
                            i2 = i;

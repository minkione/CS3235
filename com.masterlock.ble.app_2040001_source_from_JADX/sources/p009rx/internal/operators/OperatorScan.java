        ...
        if (call == NO_INITIAL_VALUE) {
            return new Subscriber<T>(subscriber) {
                ...
                public void onNext(java.lang.Object r3) {
                    ...
                    L_0x0008:
                        R r0 = r2.value
                        rx.internal.operators.OperatorScan r1 = p009rx.internal.operators.OperatorScan.this     // Catch:{ Throwable -> 0x001a }
                        rx.functions.Func2<R, ? super T, R> r1 = r1.accumulator     // Catch:{ Throwable -> 0x001a }
                        java.lang.Object r3 = r1.call(r0, r3)     // Catch:{ Throwable -> 0x001a }
                    L_0x0012:
                        r2.value = r3
                        rx.Subscriber r0 = r4
                        r0.onNext(r3)
                    ...
                    L_0x001a:
                        r0 = move-exception
                        rx.Subscriber r1 = r4
                        p009rx.exceptions.Exceptions.throwOrReport(r0, r1, r3)
                        return
                    */
                    throw new UnsupportedOperationException("Method not decompiled: p009rx.internal.operators.OperatorScan.C21182.onNext(java.lang.Object):void");
                }

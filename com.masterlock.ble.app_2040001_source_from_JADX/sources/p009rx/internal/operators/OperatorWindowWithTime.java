...
public final class OperatorWindowWithTime<T> implements Operator<Observable<T>, T> {
    ...
    final class ExactSubscriber extends Subscriber<T> {
        ...
        public ExactSubscriber(Subscriber<? super Observable<T>> subscriber, Worker worker2) {
        ...
        public void onNext(T r5) {
            ...
            L_0x0064:
                ...
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: p009rx.internal.operators.OperatorWindowWithTime.ExactSubscriber.onNext(java.lang.Object):void");
        }
        ...
        public void nextWindow() {
            ...
            L_0x0012:
                java.util.List<java.lang.Object> r1 = r6.queue     // Catch:{ all -> 0x0069 }
                java.lang.Object r2 = p009rx.internal.operators.OperatorWindowWithTime.NEXT_SUBJECT     // Catch:{ all -> 0x0069 }
            ...
            L_0x0069:
                ...
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: p009rx.internal.operators.OperatorWindowWithTime.ExactSubscriber.nextWindow():void");
        }
    }
    ...
    final class InexactSubscriber extends Subscriber<T> {
        ...
        public InexactSubscriber(Subscriber<? super Observable<T>> subscriber, Worker worker2) {
            super(subscriber);
        ...
        /* JADX WARNING: Code restructure failed: missing block: B:17:0x003d, code lost:
            r1 = (p009rx.internal.operators.OperatorWindowWithTime.CountedSerializedSubject) r0.next();
        ...
        public void onNext(T r6) {
            ...
            L_0x0016:
                ...
                rx.internal.operators.OperatorWindowWithTime$CountedSerializedSubject r3 = (p009rx.internal.operators.OperatorWindowWithTime.CountedSerializedSubject) r3     // Catch:{ all -> 0x0057 }
                int r4 = r3.count     // Catch:{ all -> 0x0057 }
                int r4 = r4 + 1
                r3.count = r4     // Catch:{ all -> 0x0057 }
                rx.internal.operators.OperatorWindowWithTime r3 = p009rx.internal.operators.OperatorWindowWithTime.this     // Catch:{ all -> 0x0057 }
            ...
            L_0x0037:
                ...
                rx.internal.operators.OperatorWindowWithTime$CountedSerializedSubject r1 = (p009rx.internal.operators.OperatorWindowWithTime.CountedSerializedSubject) r1
                rx.Observer<T> r2 = r1.consumer
                r2.onNext(r6)
                int r2 = r1.count
                rx.internal.operators.OperatorWindowWithTime r3 = p009rx.internal.operators.OperatorWindowWithTime.this
                int r3 = r3.size
            ...
            L_0x0057:
                ...
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: p009rx.internal.operators.OperatorWindowWithTime.InexactSubscriber.onNext(java.lang.Object):void");
        }
        ...
        /* JADX WARNING: Code restructure failed: missing block: B:12:0x0023, code lost:
            ((p009rx.internal.operators.OperatorWindowWithTime.CountedSerializedSubject) r0.next()).consumer.onError(r4);
         */
        ...
        public void onError(java.lang.Throwable r4) {
            ...
            L_0x0035:
                ...
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: p009rx.internal.operators.OperatorWindowWithTime.InexactSubscriber.onError(java.lang.Throwable):void");
        }
         ...
         */
        /* JADX WARNING: Code restructure failed: missing block: B:12:0x0023, code lost:
            ((p009rx.internal.operators.OperatorWindowWithTime.CountedSerializedSubject) r0.next()).consumer.onCompleted();
         */
        /* JADX WARNING: Code restructure failed: missing block: B:13:0x002f, code lost:
        ...
        public void onCompleted() {
            ...
            L_0x0035:
                ...
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: p009rx.internal.operators.OperatorWindowWithTime.InexactSubscriber.onCompleted():void");
        }
         ...
         */
        /* Code decompiled incorrectly, please refer to instructions dump. */
        public void terminateChunk(p009rx.internal.operators.OperatorWindowWithTime.CountedSerializedSubject<T> r4) {
            /*
                r3 = this;
                java.lang.Object r0 = r3.guard
                monitor-enter(r0)
            ...
            L_0x000f:
                ...
                rx.internal.operators.OperatorWindowWithTime$CountedSerializedSubject r2 = (p009rx.internal.operators.OperatorWindowWithTime.CountedSerializedSubject) r2     // Catch:{ all -> 0x002c }
            ...
            L_0x002c:
                ...
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: p009rx.internal.operators.OperatorWindowWithTime.InexactSubscriber.terminateChunk(rx.internal.operators.OperatorWindowWithTime$CountedSerializedSubject):void");
        }

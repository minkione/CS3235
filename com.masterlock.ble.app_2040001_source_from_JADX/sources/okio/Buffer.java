...
public final class Buffer implements BufferedSource, BufferedSink, Cloneable {
        ...
        if (str != null) {
            ...
            while (i < length) {
                ...
                if (charAt < 128) {
                    ...
                    int i5 = (i2 + i3) - writableSegment.limit;
    ...
    public Segment writableSegment(int i) {
        ...
        if (segment3.limit + i > 2048 || !segment3.owner) {
        ...
        try {
            ...
            while (true) {
                ...
                if (segment != this.head) {
                    ...
                    return String.format("Buffer[size=%s md5=%s]", new Object[]{Long.valueOf(this.size), ByteString.m205of(instance.digest()).hex()});
                }
            }

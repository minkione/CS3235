...
public class FirmwareUpdateCompleted extends IEvent {
    public static final int FIRMWARE_VERSION_LOCATION = 8;
    public static final int USER_ID_LOCATION = 4;
    public static final AuditEventId mAuditEventId = AuditEventId.FIRMWARE_UPDATE_COMPLETED;
    private int mFirmwareVersion;
    private int mTime;
    private int mUserId;

    public FirmwareUpdateCompleted(byte[] bArr) {

...
public class LockNameKeySafeView extends LinearLayout implements IAuthenticatedView {
    ...
    public LockNameKeySafePresenter mLockNameKeySafePresenter;
    ...
    public LockNameKeySafeView(Context context) {
        this(context, null);
    }

    public LockNameKeySafeView(Context context, AttributeSet attributeSet) {
    ...
    public void onAttachedToWindow() {
        ...
        if (!isInEditMode()) {
            ...
            initSuggestionList();
            this.mLockNameKeySafePresenter = new LockNameKeySafePresenter(this);
            this.mLockNameKeySafePresenter.start();
            ...
            this.mLockName.getEditText().setOnEditorActionListener(new OnEditorActionListener() {
                public final boolean onEditorAction(TextView textView, int i, KeyEvent keyEvent) {
                    return LockNameKeySafeView.lambda$onAttachedToWindow$0(LockNameKeySafeView.this, textView, i, keyEvent);
                }
            });
            this.mLockName.getEditText().addTextChangedListener(new TextWatcher() {
                ...
                public void onTextChanged(CharSequence charSequence, int i, int i2, int i3) {
                    if (!LockNameKeySafeView.this.mLockNameKeySafePresenter.isSameLockname(charSequence.toString())) {
                        LockNameKeySafeView.this.mSaveNameButton.setEnabled(true);
                        LockNameKeySafeView.this.mSaveNameButton.setTextColor(LockNameKeySafeView.this.getResources().getColor(C1075R.color.primary));
                        return;
                    }
                    LockNameKeySafeView.this.mSaveNameButton.setEnabled(false);
                    LockNameKeySafeView.this.mSaveNameButton.setTextColor(LockNameKeySafeView.this.getResources().getColor(C1075R.color.light_grey));
                }
            });
        }
    }

    public static /* synthetic */ boolean lambda$onAttachedToWindow$0(LockNameKeySafeView lockNameKeySafeView, TextView textView, int i, KeyEvent keyEvent) {
    ...
    public void onDetachedFromWindow() {
        ...
        this.mLockNameKeySafePresenter.finish();
    ...
    public void onSaveClicked() {
        ...
        if (isEmpty.isEmpty()) {
            this.mLockNameKeySafePresenter.updateName(this.mLockName.getText());
            return;
        }

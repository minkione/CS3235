...
public class AboutLockPadLockView extends LinearLayout implements IAuthenticatedView {
    public ArrayAdapter listAdapter;
    private AboutLockPadLockPresenter mAboutLockPadLockPresenter;
    ...
    public AboutLockPadLockView(Context context) {
        this(context, null);
    }

    public AboutLockPadLockView(Context context, AttributeSet attributeSet) {
    ...
    public void onAttachedToWindow() {
        ...
        if (!isInEditMode()) {
            ...
            AboutLockPadLock aboutLockPadLock = (AboutLockPadLock) AppFlow.getScreen(getContext());
            this.mAboutLockPadLockPresenter = new AboutLockPadLockPresenter(aboutLockPadLock.mLock, this);
            this.mFirmwareUpdateButton.setVisibility(4);
            this.mLock = aboutLockPadLock.mLock;
        }
    }
    ...
    public void updateFirmware() {
        AboutLockPadLock aboutLockPadLock = (AboutLockPadLock) AppFlow.getScreen(getContext());
        if (!this.mHasFuFile) {
            this.mAboutLockPadLockPresenter.goToDownloadFirmwareView();
        } else if (this.mLock.isLockerMode()) {
            this.mAboutLockPadLockPresenter.displayLockermodeDialog();
        } else {
            this.mAboutLockPadLockPresenter.goToInstallView();
        }
    }
}

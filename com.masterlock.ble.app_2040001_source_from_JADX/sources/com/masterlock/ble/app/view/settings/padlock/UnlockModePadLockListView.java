...
public class UnlockModePadLockListView extends RelativeLayout implements IAuthenticatedView {
    ...
    private UnlockModePadLockPresenter mUnlockModePadLockPresenter;
    @InjectView(2131296422)
    TextView txtDeviceId;

    public UnlockModePadLockListView(Context context) {
        super(context);
    }

    public UnlockModePadLockListView(Context context, AttributeSet attributeSet) {
        super(context, attributeSet);
    }

    public UnlockModePadLockListView(Context context, AttributeSet attributeSet, int i) {
    ...
    public void onAttachedToWindow() {
        ...
        if (!isInEditMode()) {
            this.mUnlockModePadLockPresenter.start();
        }
    }
    ...
    public void onDetachedFromWindow() {
        ...
        this.mUnlockModePadLockPresenter.finish();
    }
    ...
    public void onFinishInflate() {
        ...
        if (!isInEditMode()) {
            ...
            this.mUnlockModePadLockPresenter = new UnlockModePadLockPresenter(this);
            this.mInitialMode = this.mUnlockModePadLockPresenter.getLock().getLockMode();
            setUpClickListeners();
    ...
    private void setUpClickListeners() {
        this.mTouchUnlockSelectListener = new OnClickListener() {
            public final void onClick(View view) {
                UnlockModePadLockListView.this.setActiveCardForMode(LockMode.TOUCH);
            }
        };
        this.mProximitySwipeSelectListener = new OnClickListener() {
            public final void onClick(View view) {
                UnlockModePadLockListView.this.setActiveCardForMode(LockMode.PROXIMITYSWIPE);
            }
        };
    }
        ...
        if (lockMode != null && !lockMode.equals(LockMode.UNKNOWN)) {
            switch (lockMode) {
                case PROXIMITYSWIPE:
                    ...
                    this.mUnlockModePadLockPresenter.setLockMode(LockMode.PROXIMITYSWIPE);
                ...
                case TOUCH:
                    ...
                    this.mUnlockModePadLockPresenter.setLockMode(LockMode.TOUCH);
                    enableSaveOnNewSelection(LockMode.TOUCH);
                    break;
                case PROXIMITY:
                    this.mProximitySwipeModeCard.setCardAsInactive();
                    this.mTouchModeCard.setCardAsInactive();
                    this.mUnlockModePadLockPresenter.setLockMode(LockMode.PROXIMITY);
    ...
    @OnClick({2131296354})
    public void onSave() {
        this.mUnlockModePadLockPresenter.saveNewUnlockMode();
    }

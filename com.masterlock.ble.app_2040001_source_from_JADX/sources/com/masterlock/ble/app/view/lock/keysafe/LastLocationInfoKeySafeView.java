...
public class LastLocationInfoKeySafeView extends LinearLayout implements IAuthenticatedView {
    ...
    private LastLocationInfoKeySafePresenter mPresenter;

    public LastLocationInfoKeySafeView(Context context, AttributeSet attributeSet) {
    ...
    public void onFinishInflate() {
        ...
        if (!isInEditMode()) {
            ...
            this.mLock = ((LastLocationInfoKeySafe) AppFlow.getScreen(getContext())).mLock;
            this.mPresenter = new LastLocationInfoKeySafePresenter(this.mLock, this);
        }
    }

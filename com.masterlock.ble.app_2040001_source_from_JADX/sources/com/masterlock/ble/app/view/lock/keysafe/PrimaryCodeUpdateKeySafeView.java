...
public class PrimaryCodeUpdateKeySafeView extends LinearLayout implements IAuthenticatedView {
    public static final int PRIMARY_CODE_MIN_SIZE = 4;
    public static final int PRIMARY_CODE_SIZE = 8;
    private int mCurrentCode = 0;
    private StringBuilder mEnteredLockCodeSB;
    private List<View> mLockCodeViewList;
    private PrimaryCodeUpdateKeySafePresenter mPrimaryCodeUpdateKeySafePresenter;

    public PrimaryCodeUpdateKeySafeView(Context context) {
        super(context);
    }

    public PrimaryCodeUpdateKeySafeView(Context context, AttributeSet attributeSet) {
        super(context, attributeSet);
    }

    public PrimaryCodeUpdateKeySafeView(Context context, AttributeSet attributeSet, int i) {
    ...
    public void onFinishInflate() {
        ...
        if (!isInEditMode()) {
            ...
            this.mPrimaryCodeUpdateKeySafePresenter = new PrimaryCodeUpdateKeySafePresenter(((PrimaryCodeUpdateKeySafe) AppFlow.getScreen(getContext())).mLock, this);
    ...
    private void buildLockCodeContainer() {
        ...
        for (int i = 0; i < 8; i++) {
            View inflate = layoutInflater.inflate(C1075R.layout.update_lock_code_item_key_safe, linearLayout, false);
    ...
    public void onAttachedToWindow() {
        ...
        if (!isInEditMode()) {
            this.mPrimaryCodeUpdateKeySafePresenter.start();
        }
    }
    ...
    public void onDetachedFromWindow() {
        ...
        this.mPrimaryCodeUpdateKeySafePresenter.finish();
    }

    /* access modifiers changed from: 0000 */
    @OnClick({2131296350})
    public void savePrimaryCode() {
        this.mPrimaryCodeUpdateKeySafePresenter.validateCode(this.mEnteredLockCodeSB.toString());
    }
    ...
    private boolean updateDisplayedLockCode(int i) {
        ...
        TextView textView = (TextView) ButterKnife.findById((View) this.mLockCodeViewList.get(this.mCurrentCode - 1), (int) C1075R.C1077id.txt_code_direction);
    ...
    public void deleteCodeEntry() {
        ...
        ButterKnife.findById((View) this.mLockCodeViewList.get(this.mCurrentCode), (int) C1075R.C1077id.txt_code_direction).setVisibility(4);

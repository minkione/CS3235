...
public class GoogleSignInOptions extends AbstractSafeParcelable implements Optional, ReflectedParcelable {
    ...
    @Field(getter = "isForceCodeForRefreshToken", mo9239id = 6)
    public final boolean zaaa;
    /* access modifiers changed from: private */
    @Field(getter = "getServerClientId", mo9239id = 7)
    public String zaab;
    /* access modifiers changed from: private */
    @Field(getter = "getHostedDomain", mo9239id = 8)
    public String zaac;
    /* access modifiers changed from: private */
    @Field(getter = "getExtensions", mo9239id = 9)
    ...
    /* access modifiers changed from: private */
    @Field(getter = "getScopes", mo9239id = 2)
    public final ArrayList<Scope> zaw;
    /* access modifiers changed from: private */
    @Field(getter = "getAccount", mo9239id = 3)
    public Account zax;
    /* access modifiers changed from: private */
    @Field(getter = "isIdTokenRequested", mo9239id = 4)
    public boolean zay;
    /* access modifiers changed from: private */
    @Field(getter = "isServerAuthCodeRequested", mo9239id = 5)
    ...
    @Constructor
    GoogleSignInOptions(@Param(mo9242id = 1) int i, @Param(mo9242id = 2) ArrayList<Scope> arrayList, @Param(mo9242id = 3) Account account, @Param(mo9242id = 4) boolean z, @Param(mo9242id = 5) boolean z2, @Param(mo9242id = 6) boolean z3, @Param(mo9242id = 7) String str, @Param(mo9242id = 8) String str2, @Param(mo9242id = 9) ArrayList<GoogleSignInOptionsExtensionParcelable> arrayList2) {

...
public final class zaa extends AbstractSafeParcelable implements Result {
    ...
    @Field(getter = "getConnectionResultCode", mo9239id = 2)
    private int zarw;
    @Field(getter = "getRawAuthResolutionIntent", mo9239id = 3)
    private Intent zarx;

    @Constructor
    zaa(@Param(mo9242id = 1) int i, @Param(mo9242id = 2) int i2, @Param(mo9242id = 3) Intent intent) {
        this.zale = i;
        this.zarw = i2;
        this.zarx = intent;
    }

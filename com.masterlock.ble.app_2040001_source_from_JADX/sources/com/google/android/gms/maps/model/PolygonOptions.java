...
public final class PolygonOptions extends AbstractSafeParcelable {
    ...
    @Field(getter = "isClickable", mo9239id = 10)
    private boolean zzcu;
    @Nullable
    @Field(getter = "getStrokePattern", mo9239id = 12)
    private List<PatternItem> zzcv;
    @Field(getter = "getPoints", mo9239id = 2)
    private final List<LatLng> zzdx;
    @Field(getter = "getHolesForParcel", mo9239id = 3, type = "java.util.List")
    private final List<List<LatLng>> zzdy;
    @Field(getter = "isGeodesic", mo9239id = 9)
    private boolean zzdz;
    @Field(getter = "getStrokeJointType", mo9239id = 11)
    private int zzea;
    ...
    @Constructor
    PolygonOptions(@Param(mo9242id = 2) List<LatLng> list, @Param(mo9242id = 3) List list2, @Param(mo9242id = 4) float f, @Param(mo9242id = 5) int i, @Param(mo9242id = 6) int i2, @Param(mo9242id = 7) float f2, @Param(mo9242id = 8) boolean z, @Param(mo9242id = 9) boolean z2, @Param(mo9242id = 10) boolean z3, @Param(mo9242id = 11) int i3, @Nullable @Param(mo9242id = 12) List<PatternItem> list3) {
        this.zzcr = 10.0f;
        this.strokeColor = ViewCompat.MEASURED_STATE_MASK;
        this.fillColor = 0;
        this.zzcs = 0.0f;

...
public final class PolylineOptions extends AbstractSafeParcelable {
    ...
    @Field(getter = "getColor", mo9239id = 4)
    private int color;
    @Field(getter = "getWidth", mo9239id = 3)
    private float width;
    @Field(getter = "getZIndex", mo9239id = 5)
    private float zzcs;
    @Field(getter = "isVisible", mo9239id = 6)
    private boolean zzct;
    @Field(getter = "isClickable", mo9239id = 8)
    private boolean zzcu;
    @Field(getter = "getPoints", mo9239id = 2)
    private final List<LatLng> zzdx;
    @Field(getter = "isGeodesic", mo9239id = 7)
    private boolean zzdz;
    @Field(getter = "getStartCap", mo9239id = 9)
    @NonNull
    private Cap zzec;
    @Field(getter = "getEndCap", mo9239id = 10)
    @NonNull
    private Cap zzed;
    @Field(getter = "getJointType", mo9239id = 11)
    private int zzee;
    @Nullable
    @Field(getter = "getPattern", mo9239id = 12)
    ...
    @Constructor
    PolylineOptions(@Param(mo9242id = 2) List list, @Param(mo9242id = 3) float f, @Param(mo9242id = 4) int i, @Param(mo9242id = 5) float f2, @Param(mo9242id = 6) boolean z, @Param(mo9242id = 7) boolean z2, @Param(mo9242id = 8) boolean z3, @Nullable @Param(mo9242id = 9) Cap cap, @Nullable @Param(mo9242id = 10) Cap cap2, @Param(mo9242id = 11) int i2, @Nullable @Param(mo9242id = 12) List<PatternItem> list2) {
        this.width = 10.0f;
        this.color = ViewCompat.MEASURED_STATE_MASK;
        this.zzcs = 0.0f;
        this.zzct = true;

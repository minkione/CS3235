...
public final class GroundOverlayOptions extends AbstractSafeParcelable {
    ...
    @Field(getter = "getBearing", mo9239id = 7)
    private float bearing;
    @Field(getter = "getHeight", mo9239id = 5)
    private float height;
    @Field(getter = "getWidth", mo9239id = 4)
    private float width;
    @Field(getter = "getZIndex", mo9239id = 8)
    private float zzcs;
    @Field(getter = "isVisible", mo9239id = 9)
    private boolean zzct = true;
    @Field(getter = "isClickable", mo9239id = 13)
    private boolean zzcu = false;
    @Field(getter = "getWrappedImageDescriptorImplBinder", mo9239id = 2, type = "android.os.IBinder")
    @NonNull
    private BitmapDescriptor zzcx;
    @Field(getter = "getLocation", mo9239id = 3)
    private LatLng zzcy;
    @Field(getter = "getBounds", mo9239id = 6)
    private LatLngBounds zzcz;
    @Field(getter = "getTransparency", mo9239id = 10)
    private float zzda = 0.0f;
    @Field(getter = "getAnchorU", mo9239id = 11)
    private float zzdb = 0.5f;
    @Field(getter = "getAnchorV", mo9239id = 12)
    private float zzdc = 0.5f;

    @Constructor
    GroundOverlayOptions(@Param(mo9242id = 2) IBinder iBinder, @Param(mo9242id = 3) LatLng latLng, @Param(mo9242id = 4) float f, @Param(mo9242id = 5) float f2, @Param(mo9242id = 6) LatLngBounds latLngBounds, @Param(mo9242id = 7) float f3, @Param(mo9242id = 8) float f4, @Param(mo9242id = 9) boolean z, @Param(mo9242id = 10) float f5, @Param(mo9242id = 11) float f6, @Param(mo9242id = 12) float f7, @Param(mo9242id = 13) boolean z2) {

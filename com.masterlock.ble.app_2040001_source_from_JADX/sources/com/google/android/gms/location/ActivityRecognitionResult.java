...
public class ActivityRecognitionResult extends AbstractSafeParcelable implements ReflectedParcelable {
    ...
    @Constructor
    public ActivityRecognitionResult(@Param(mo9242id = 1) List<DetectedActivity> list, @Param(mo9242id = 2) long j, @Param(mo9242id = 3) long j2, @Param(mo9242id = 4) int i, @Param(mo9242id = 5) Bundle bundle) {
        boolean z = true;

...
public final class LocationRequest extends AbstractSafeParcelable implements ReflectedParcelable {
    ...
    @Field(defaultValueUnchecked = "LocationRequest.DEFAULT_PRIORITY", mo9239id = 1)
    private int priority;
    @Field(defaultValueUnchecked = "LocationRequest.DEFAULT_EXPIRE_AT", mo9239id = 5)
    private long zzaf;
    @Field(defaultValueUnchecked = "LocationRequest.DEFAULT_INTERVAL", mo9239id = 2)
    private long zzaw;
    @Field(defaultValueUnchecked = "LocationRequest.DEFAULT_FASTEST_INTERVAL", mo9239id = 3)
    private long zzax;
    @Field(defaultValueUnchecked = "LocationRequest.DEFAULT_EXPLICIT_FASTEST_INTERVAL", mo9239id = 4)
    private boolean zzay;
    @Field(defaultValueUnchecked = "LocationRequest.DEFAULT_SMALLEST_DISPLACEMENT", mo9239id = 7)
    private float zzaz;
    @Field(defaultValueUnchecked = "LocationRequest.DEFAULT_MAX_WAIT_TIME", mo9239id = 8)
    private long zzba;
    @Field(defaultValueUnchecked = "LocationRequest.DEFAULT_NUM_UPDATES", mo9239id = 6)
    private int zzx;
    ...
    @Constructor
    LocationRequest(@Param(mo9242id = 1) int i, @Param(mo9242id = 2) long j, @Param(mo9242id = 3) long j2, @Param(mo9242id = 4) boolean z, @Param(mo9242id = 5) long j3, @Param(mo9242id = 6) int i2, @Param(mo9242id = 7) float f, @Param(mo9242id = 8) long j4) {
        this.priority = i;
        this.zzaw = j;
        this.zzax = j2;
        this.zzay = z;

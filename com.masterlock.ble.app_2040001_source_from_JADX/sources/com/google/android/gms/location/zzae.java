...
public final class zzae extends AbstractSafeParcelable {
    ...
    @Field(defaultValue = "", getter = "getJustificationText", mo9239id = 1)
    private final String zzbd;
    @Field(defaultValue = "", getter = "getExperimentId", mo9239id = 2)
    private final String zzbe;
    @Field(defaultValue = "", getter = "getTitleText", mo9239id = 5)
    private final String zzbf;

    @Constructor
    zzae(@Param(mo9242id = 5) String str, @Param(mo9242id = 1) String str2, @Param(mo9242id = 2) String str3) {
        this.zzbf = str;
        this.zzbd = str2;
        this.zzbe = str3;
    }

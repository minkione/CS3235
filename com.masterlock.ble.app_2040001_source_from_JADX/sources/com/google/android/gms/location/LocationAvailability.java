...
public final class LocationAvailability extends AbstractSafeParcelable implements ReflectedParcelable {
    ...
    @Deprecated
    private int zzas;
    @Field(defaultValueUnchecked = "0", mo9239id = 3)
    private long zzat;
    @Field(defaultValueUnchecked = "LocationAvailability.STATUS_UNSUCCESSFUL", mo9239id = 4)
    private int zzau;
    @Field(mo9239id = 5)
    private zzaj[] zzav;

    @Constructor
    LocationAvailability(@Param(mo9242id = 4) int i, @Param(mo9242id = 1) int i2, @Param(mo9242id = 2) int i3, @Param(mo9242id = 3) long j, @Param(mo9242id = 5) zzaj[] zzajArr) {
        this.zzau = i;
        this.zzar = i2;
        this.zzas = i3;
        this.zzat = j;

...
public class PlaceReport extends AbstractSafeParcelable implements ReflectedParcelable {
    ...
    @Field(getter = "getTag", mo9239id = 3)
    private final String tag;
    @VersionField(mo9245id = 1)
    private final int versionCode;
    @Field(getter = "getPlaceId", mo9239id = 2)
    private final String zza;
    @Field(getter = "getSource", mo9239id = 4)
    private final String zzb;

    @Constructor
    PlaceReport(@Param(mo9242id = 1) int i, @Param(mo9242id = 2) String str, @Param(mo9242id = 3) String str2, @Param(mo9242id = 4) String str3) {
        this.versionCode = i;
        this.zza = str;
        this.tag = str2;
        this.zzb = str3;

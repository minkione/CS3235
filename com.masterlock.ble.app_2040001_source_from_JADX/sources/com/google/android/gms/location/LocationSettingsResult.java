...
public final class LocationSettingsResult extends AbstractSafeParcelable implements Result {
    ...
    @Field(getter = "getStatus", mo9239id = 1)
    private final Status zzbl;
    @Field(getter = "getLocationSettingsStates", mo9239id = 2)
    ...
    @Constructor
    public LocationSettingsResult(@Param(mo9242id = 1) Status status, @Param(mo9242id = 2) LocationSettingsStates locationSettingsStates) {
        this.zzbl = status;

...
public final class zzal extends AbstractSafeParcelable {
    ...
    @Field(defaultValue = "", getter = "getTag", mo9239id = 3)
    private final String tag;
    @Field(getter = "getGeofenceIds", mo9239id = 1)
    private final List<String> zzbu;
    @Field(getter = "getPendingIntent", mo9239id = 2)
    private final PendingIntent zzbv;

    @Constructor
    zzal(@Nullable @Param(mo9242id = 1) List<String> list, @Nullable @Param(mo9242id = 2) PendingIntent pendingIntent, @Param(mo9242id = 3) String str) {

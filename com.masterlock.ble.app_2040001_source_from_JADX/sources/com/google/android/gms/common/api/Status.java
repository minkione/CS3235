...
public final class Status extends AbstractSafeParcelable implements Result, ReflectedParcelable {
    ...
    @Field(getter = "getStatusCode", mo9239id = 1)
    private final int zzh;
    @Nullable
    @Field(getter = "getPendingIntent", mo9239id = 3)
    private final PendingIntent zzi;
    @Nullable
    @Field(getter = "getStatusMessage", mo9239id = 2)
    private final String zzj;

    @Constructor
    @KeepForSdk
    Status(@Param(mo9242id = 1000) int i, @Param(mo9242id = 1) int i2, @Nullable @Param(mo9242id = 2) String str, @Nullable @Param(mo9242id = 3) PendingIntent pendingIntent) {
        this.zzg = i;
        this.zzh = i2;
        this.zzj = str;

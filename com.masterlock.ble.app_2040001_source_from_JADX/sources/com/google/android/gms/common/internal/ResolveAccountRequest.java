...
public class ResolveAccountRequest extends AbstractSafeParcelable {
    ...
    @Field(getter = "getSessionId", mo9239id = 3)
    private final int zaoz;
    @Field(getter = "getSignInAccountHint", mo9239id = 4)
    private final GoogleSignInAccount zapa;
    @Field(getter = "getAccount", mo9239id = 2)
    private final Account zax;

    @Constructor
    ResolveAccountRequest(@Param(mo9242id = 1) int i, @Param(mo9242id = 2) Account account, @Param(mo9242id = 3) int i2, @Param(mo9242id = 4) GoogleSignInAccount googleSignInAccount) {
        this.zale = i;
        this.zax = account;
        this.zaoz = i2;

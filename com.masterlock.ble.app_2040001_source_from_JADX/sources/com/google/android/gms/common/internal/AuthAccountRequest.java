...
public class AuthAccountRequest extends AbstractSafeParcelable {
    ...
    @Field(mo9239id = 6, type = "android.accounts.Account")
    private Account zax;

    @Constructor
    AuthAccountRequest(@Param(mo9242id = 1) int i, @Param(mo9242id = 2) IBinder iBinder, @Param(mo9242id = 3) Scope[] scopeArr, @Param(mo9242id = 4) Integer num, @Param(mo9242id = 5) Integer num2, @Param(mo9242id = 6) Account account) {
        this.zale = i;
        this.zanw = iBinder;
        this.zanx = scopeArr;
        this.zany = num;

...
public class GetServiceRequest extends AbstractSafeParcelable {
    ...
    @Constructor
    GetServiceRequest(@Param(mo9242id = 1) int i, @Param(mo9242id = 2) int i2, @Param(mo9242id = 3) int i3, @Param(mo9242id = 4) String str, @Param(mo9242id = 5) IBinder iBinder, @Param(mo9242id = 6) Scope[] scopeArr, @Param(mo9242id = 7) Bundle bundle, @Param(mo9242id = 8) Account account, @Param(mo9242id = 10) Feature[] featureArr, @Param(mo9242id = 11) Feature[] featureArr2, @Param(mo9242id = 12) boolean z) {
        this.version = i;
        this.zzdf = i2;
        this.zzdg = i3;

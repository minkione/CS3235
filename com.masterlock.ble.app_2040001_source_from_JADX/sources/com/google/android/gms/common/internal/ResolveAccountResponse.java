...
public class ResolveAccountResponse extends AbstractSafeParcelable {
    ...
    @Field(getter = "getConnectionResult", mo9239id = 3)
    private ConnectionResult zadh;
    @Field(getter = "getSaveDefaultAccount", mo9239id = 4)
    private boolean zagf;
    @VersionField(mo9245id = 1)
    private final int zale;
    @Field(mo9239id = 2)
    private IBinder zanw;
    @Field(getter = "isFromCrossClientAuth", mo9239id = 5)
    private boolean zapb;

    @Constructor
    ResolveAccountResponse(@Param(mo9242id = 1) int i, @Param(mo9242id = 2) IBinder iBinder, @Param(mo9242id = 3) ConnectionResult connectionResult, @Param(mo9242id = 4) boolean z, @Param(mo9242id = 5) boolean z2) {
        this.zale = i;
        this.zanw = iBinder;

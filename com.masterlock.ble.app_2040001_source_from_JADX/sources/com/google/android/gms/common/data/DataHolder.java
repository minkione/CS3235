...
public final class DataHolder extends AbstractSafeParcelable implements Closeable {
    ...
    @VersionField(mo9245id = 1000)
    private final int zale;
    @Field(getter = "getColumns", mo9239id = 1)
    private final String[] zalp;
    private Bundle zalq;
    @Field(getter = "getWindows", mo9239id = 2)
    private final CursorWindow[] zalr;
    @Field(getter = "getStatusCode", mo9239id = 3)
    private final int zals;
    @Field(getter = "getMetadata", mo9239id = 4)
    ...
    @Constructor
    DataHolder(@Param(mo9242id = 1000) int i, @Param(mo9242id = 1) String[] strArr, @Param(mo9242id = 2) CursorWindow[] cursorWindowArr, @Param(mo9242id = 3) int i2, @Param(mo9242id = 4) Bundle bundle) {
        this.mClosed = false;
        this.zalw = true;
        this.zale = i;
        this.zalp = strArr;

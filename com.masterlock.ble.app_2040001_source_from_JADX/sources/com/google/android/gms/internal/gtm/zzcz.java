...
public final class zzcz {
    ...
    public static String zzc(boolean z) {
        return z ? MasterBackupResponse.SUCCESS : "0";
    }
    ...
    public static boolean zzb(String str, boolean z) {
        if (str == null || str.equalsIgnoreCase("true") || str.equalsIgnoreCase("yes") || str.equalsIgnoreCase(MasterBackupResponse.SUCCESS)) {
            return true;
        }
    ...
    public static zzr zza(zzci zzci, String str) {
        ...
        try {
            ...
            Map parse = HttpUtils.parse(new URI(valueOf.length() != 0 ? str2.concat(valueOf) : new String(str2)), HttpRequest.CHARSET_UTF8);
            zzr zzr = new zzr();
    ...
    public static void zzb(Map<String, String> map, String str, boolean z) {
        if (!map.containsKey(str)) {
            map.put(str, z ? MasterBackupResponse.SUCCESS : "0");
        }
    }

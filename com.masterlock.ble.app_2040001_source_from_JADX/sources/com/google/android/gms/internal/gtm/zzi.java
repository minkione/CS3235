...
import com.google.android.gms.internal.gtm.zzc.zza.C2262zza;
...
public final class zzi extends zzuq<zzi> {
    ...
    public zzi() {
        this.zzph = zzuz.zzbhu;
        this.zzpi = zzuz.zzbhu;
        this.zzpj = zzl.zzaa();
        this.zzpk = new zzd[0];
        this.zzpl = new zzb[0];
        this.zzpm = new zzb[0];
        ...
        while (true) {
            ...
            switch (zzni) {
                ...
                case 114:
                    ...
                    zza zza2 = this.zzps;
                    if (zza2 != null) {
                        zza = (zza) ((zzrc) ((C2262zza) ((C2262zza) zza2.zzpd()).zza(zza)).zzpm());
                    }
                    this.zzps = zza;
                    break;
                case 125:

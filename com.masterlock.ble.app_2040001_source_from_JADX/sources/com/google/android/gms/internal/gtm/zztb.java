...
final class zztb {
    ...
    static int zzw(List<Long> list) {
        ...
        if (list instanceof zzry) {
            ...
            int i3 = 0;
            while (i2 < size) {
                i3 = i + zzqj.zzs(((Long) list.get(i2)).longValue());
                i2++;
            }
        }
        return i;
    ...
    static int zzx(List<Long> list) {
        ...
        if (list instanceof zzry) {
            ...
            int i3 = 0;
            while (i2 < size) {
                i3 = i + zzqj.zzt(((Long) list.get(i2)).longValue());
                i2++;
            }
        }
        return i;
    ...
    static int zzy(List<Long> list) {
        ...
        if (list instanceof zzry) {
            ...
            int i3 = 0;
            while (i2 < size) {
                i3 = i + zzqj.zzu(((Long) list.get(i2)).longValue());
                i2++;
            }
        }
        return i;
    ...
    static int zzz(List<Integer> list) {
        ...
        if (list instanceof zzrd) {
            ...
            int i3 = 0;
            while (i2 < size) {
                i3 = i + zzqj.zzbh(((Integer) list.get(i2)).intValue());
                i2++;
            }
        }
        return i;
    ...
    static int zzaa(List<Integer> list) {
        ...
        if (list instanceof zzrd) {
            ...
            int i3 = 0;
            while (i2 < size) {
                i3 = i + zzqj.zzbc(((Integer) list.get(i2)).intValue());
                i2++;
            }
        }
        return i;
    ...
    static int zzab(List<Integer> list) {
        ...
        if (list instanceof zzrd) {
            ...
            int i3 = 0;
            while (i2 < size) {
                i3 = i + zzqj.zzbd(((Integer) list.get(i2)).intValue());
                i2++;
            }
        }
        return i;
    ...
    static int zzac(List<Integer> list) {
        ...
        if (list instanceof zzrd) {
            ...
            int i3 = 0;
            while (i2 < size) {
                i3 = i + zzqj.zzbe(((Integer) list.get(i2)).intValue());
                i2++;
            }
        }
        return i;
    ...
    static int zzd(int i, List<zzps> list) {
        ...
        for (int i2 = 0; i2 < list.size(); i2++) {
            zzbb += zzqj.zzb((zzps) list.get(i2));
        }
        return zzbb;
    }
    ...
    static int zzd(int i, List<zzsk> list, zzsz zzsz) {
        ...
        int i2 = 0;
        for (int i3 = 0; i3 < size; i3++) {
            i2 += zzqj.zzc(i, (zzsk) list.get(i3), zzsz);
        }
        return i2;
    }
        ...
        if (list instanceof RandomAccess) {
            ...
            while (it.hasNext()) {
                ...
                if (!zzrh.zzb(intValue2)) {
                    UB zza = zza(i, intValue2, ub2, zztr);
                    it.remove();
                    ub2 = zza;
                }
            }

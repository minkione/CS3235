...
public final class zzun {
    ...
    public final int zzoa() throws IOException {
        ...
        byte b2 = zzof & Ascii.DEL;
        byte zzof2 = zzof();
        if (zzof2 >= 0) {
            b = b2 | (zzof2 << 7);
        } else {
            byte b3 = b2 | ((zzof2 & Ascii.DEL) << 7);
            byte zzof3 = zzof();
            if (zzof3 >= 0) {
                b = b3 | (zzof3 << Ascii.f91SO);
            } else {
                byte b4 = b3 | ((zzof3 & Ascii.DEL) << Ascii.f91SO);
                byte zzof4 = zzof();
                if (zzof4 >= 0) {
                    b = b4 | (zzof4 << Ascii.NAK);
                } else {
                    byte b5 = b4 | ((zzof4 & Ascii.DEL) << Ascii.NAK);
                    byte zzof5 = zzof();
                    b = b5 | (zzof5 << Ascii.f84FS);
                    if (zzof5 < 0) {
                        for (int i = 0; i < 5; i++) {
                            if (zzof() >= 0) {
                                return b;
    ...
    public final int zzoc() throws IOException {
        return (zzof() & UnsignedBytes.MAX_VALUE) | ((zzof() & UnsignedBytes.MAX_VALUE) << 8) | ((zzof() & UnsignedBytes.MAX_VALUE) << Ascii.DLE) | ((zzof() & UnsignedBytes.MAX_VALUE) << Ascii.CAN);
    }

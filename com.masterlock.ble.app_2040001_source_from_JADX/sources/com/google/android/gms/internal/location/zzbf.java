...
public final class zzbf extends AbstractSafeParcelable {
    ...
    @Field(defaultValueUnchecked = "null", mo9239id = 4)
    private PendingIntent zzbv;
    @Field(defaultValueUnchecked = "LocationRequestUpdateData.OPERATION_ADD", mo9239id = 1)
    private int zzcg;
    @Field(defaultValueUnchecked = "null", getter = "getFusedLocationProviderCallbackBinder", mo9239id = 6, type = "android.os.IBinder")
    private zzaj zzcj;
    @Field(defaultValueUnchecked = "null", mo9239id = 2)
    private zzbd zzdl;
    @Field(defaultValueUnchecked = "null", getter = "getLocationListenerBinder", mo9239id = 3, type = "android.os.IBinder")
    private zzx zzdm;
    @Field(defaultValueUnchecked = "null", getter = "getLocationCallbackBinder", mo9239id = 5, type = "android.os.IBinder")
    private zzu zzdn;

    @Constructor
    zzbf(@Param(mo9242id = 1) int i, @Param(mo9242id = 2) zzbd zzbd, @Param(mo9242id = 3) IBinder iBinder, @Param(mo9242id = 4) PendingIntent pendingIntent, @Param(mo9242id = 5) IBinder iBinder2, @Param(mo9242id = 6) IBinder iBinder3) {
        this.zzcg = i;
        this.zzdl = zzbd;
        zzaj zzaj = null;

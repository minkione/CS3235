...
public final class zzo extends AbstractSafeParcelable {
    ...
    @Field(defaultValueUnchecked = "DeviceOrientationRequestUpdateData.OPERATION_ADD", mo9239id = 1)
    private int zzcg;
    @Field(defaultValueUnchecked = "null", mo9239id = 2)
    private zzm zzch;
    @Field(defaultValueUnchecked = "null", getter = "getDeviceOrientationListenerBinder", mo9239id = 3, type = "android.os.IBinder")
    private zzr zzci;
    @Field(defaultValueUnchecked = "null", getter = "getFusedLocationProviderCallbackBinder", mo9239id = 4, type = "android.os.IBinder")
    private zzaj zzcj;

    @Constructor
    zzo(@Param(mo9242id = 1) int i, @Param(mo9242id = 2) zzm zzm, @Param(mo9242id = 3) IBinder iBinder, @Param(mo9242id = 4) IBinder iBinder2) {
        this.zzcg = i;
        this.zzch = zzm;
        zzaj zzaj = null;

...
public final class zzbh extends AbstractSafeParcelable implements Geofence {
    ...
    @Field(getter = "getRequestId", mo9239id = 1)
    private final String zzad;
    @Field(getter = "getTransitionTypes", mo9239id = 7)
    private final int zzae;
    @Field(getter = "getType", mo9239id = 3)
    private final short zzag;
    @Field(getter = "getLatitude", mo9239id = 4)
    private final double zzah;
    @Field(getter = "getLongitude", mo9239id = 5)
    private final double zzai;
    @Field(getter = "getRadius", mo9239id = 6)
    private final float zzaj;
    @Field(defaultValue = "0", getter = "getNotificationResponsiveness", mo9239id = 8)
    private final int zzak;
    @Field(defaultValue = "-1", getter = "getLoiteringDelay", mo9239id = 9)
    private final int zzal;
    @Field(getter = "getExpirationTime", mo9239id = 2)
    private final long zzdo;

    @Constructor
    public zzbh(@Param(mo9242id = 1) String str, @Param(mo9242id = 7) int i, @Param(mo9242id = 3) short s, @Param(mo9242id = 4) double d, @Param(mo9242id = 5) double d2, @Param(mo9242id = 6) float f, @Param(mo9242id = 2) long j, @Param(mo9242id = 8) int i2, @Param(mo9242id = 9) int i3) {

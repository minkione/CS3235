...
final class PhoneNumberMatcher implements Iterator<PhoneNumberMatch> {
    ...
    static {
        ...
        StringBuilder sb3 = new StringBuilder(String.valueOf(str).length() + 26 + String.valueOf(sb2).length() + String.valueOf(str2).length() + String.valueOf(sb2).length() + String.valueOf(str).length() + String.valueOf(sb2).length() + String.valueOf(str2).length() + String.valueOf(limit).length() + String.valueOf(sb2).length());
        sb3.append("(?:[");
        sb3.append(str);
        sb3.append("])?");
        sb3.append("(?:");
        ...
        String valueOf2 = String.valueOf(limit3);
        String concat = valueOf2.length() != 0 ? valueOf.concat(valueOf2) : new String(valueOf);
        String str3 = "\\p{Nd}";
        String valueOf3 = String.valueOf(limit(1, 20));
        String concat2 = valueOf3.length() != 0 ? str3.concat(valueOf3) : new String(str3);
        ...
        String str4 = PhoneNumberUtil.EXTN_PATTERNS_FOR_MATCHING;
        StringBuilder sb6 = new StringBuilder(String.valueOf(sb5).length() + 13 + String.valueOf(concat).length() + String.valueOf(limit2).length() + String.valueOf(concat2).length() + String.valueOf(concat).length() + String.valueOf(concat2).length() + String.valueOf(limit4).length() + String.valueOf(str4).length());
        sb6.append("(?:");
        sb6.append(sb5);
        sb6.append(concat);
        sb6.append(")");

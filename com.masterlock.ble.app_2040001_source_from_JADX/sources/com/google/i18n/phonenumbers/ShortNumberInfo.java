...
public class ShortNumberInfo {
    ...
    public boolean isPossibleShortNumber(PhoneNumber phoneNumber) {
        ...
        for (String shortNumberMetadataForRegion : regionCodesForCountryCode) {
            ...
            if (shortNumberMetadataForRegion2 != null && this.matcherApi.matchesPossibleNumber(nationalSignificantNumber, shortNumberMetadataForRegion2.getGeneralDesc())) {
                return true;
            }
        }
        return false;
        ...
        for (String expectedCostForRegion : regionCodesForCountryCode) {
            ...
            switch (expectedCostForRegion2) {
                ...
                default:
                    ...
                    String valueOf = String.valueOf(expectedCostForRegion2);
    ...
    public String getExampleShortNumberForCost(String str, ShortNumberCost shortNumberCost) {
        ...
        int i = C10691.f155xe1b2aad7[shortNumberCost.ordinal()];
        if (i != 1) {
            switch (i) {
                case 3:
    ...
    private boolean matchesPossibleNumberAndNationalNumber(String str, PhoneNumberDesc phoneNumberDesc) {
        if (!this.matcherApi.matchesPossibleNumber(str, phoneNumberDesc) || !this.matcherApi.matchesNationalNumber(str, phoneNumberDesc, false)) {
            return false;
        }
        return true;
    }

...
final class TreeTypeAdapter<T> extends TypeAdapter<T> {
    ...
    private static class SingleTypeFactory implements TypeAdapterFactory {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> typeToken) {
            ...
            boolean z = typeToken2 != null ? typeToken2.equals(typeToken) || (this.matchRawType && this.exactType.getType() == typeToken.getRawType()) : this.hierarchyType.isAssignableFrom(typeToken.getRawType());
            if (!z) {
                return null;
            }

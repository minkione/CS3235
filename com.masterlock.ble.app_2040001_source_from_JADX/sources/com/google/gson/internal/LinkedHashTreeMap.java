...
public final class LinkedHashTreeMap<K, V> extends AbstractMap<K, V> implements Serializable {
    ...
    public LinkedHashTreeMap(java.util.Comparator r2) {
        ...
        L_0x000d:
            ...
            r1.table = r2
            com.google.gson.internal.LinkedHashTreeMap$Node<K, V>[] r2 = r1.table
            int r0 = r2.length
            int r0 = r0 / 2
            int r2 = r2.length
            int r2 = r2 / 4
    ...
    public Node<K, V> find(K k, boolean z) {
        ...
        if (node4 != null) {
            ...
            while (true) {
                int compareTo = comparable != null ? comparable.compareTo(node4.key) : comparator2.compare(k, node4.key);
                if (compareTo == 0) {
                    return node4;
                }
                if (compareTo < 0) {

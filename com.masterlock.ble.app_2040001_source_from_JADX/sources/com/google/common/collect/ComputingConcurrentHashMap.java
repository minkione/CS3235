...
class ComputingConcurrentHashMap<K, V> extends MapMakerInternalMap<K, V> {
    ...
    private static final class ComputationExceptionReference<K, V> implements ValueReference<K, V> {
        ...
        public V waitForValue() throws ExecutionException {
            throw new ExecutionException(this.f118t);
        }
    }
    ...
    static final class ComputingSegment<K, V> extends Segment<K, V> {
        ...
        public V getOrCompute(K r12, int r13, com.google.common.base.Function<? super K, ? extends V> r14) throws java.util.concurrent.ExecutionException {
            /*
                r11 = this;
            L_0x0000:
                com.google.common.collect.MapMakerInternalMap$ReferenceEntry r0 = r11.getEntry(r12, r13)     // Catch:{ all -> 0x00f6 }
                if (r0 == 0) goto L_0x0013
                java.lang.Object r1 = r11.getLiveValue(r0)     // Catch:{ all -> 0x00f6 }
                if (r1 == 0) goto L_0x0013
                r11.recordRead(r0)     // Catch:{ all -> 0x00f6 }
                r11.postReadCleanup()
                return r1
            L_0x0013:
                r1 = 0
                ...
                com.google.common.collect.MapMakerInternalMap$ValueReference r3 = r0.getValueReference()     // Catch:{ all -> 0x00f6 }
                boolean r3 = r3.isComputingReference()     // Catch:{ all -> 0x00f6 }
                if (r3 != 0) goto L_0x00d1
            L_0x0021:
                r0 = 0
                r11.lock()     // Catch:{ all -> 0x00f6 }
                r11.preWriteCleanup()     // Catch:{ all -> 0x00ee }
                int r3 = r11.count     // Catch:{ all -> 0x00ee }
                int r3 = r3 - r2
                java.util.concurrent.atomic.AtomicReferenceArray r4 = r11.table     // Catch:{ all -> 0x00ee }
                int r5 = r4.length()     // Catch:{ all -> 0x00ee }
                int r5 = r5 - r2
                r5 = r5 & r13
                java.lang.Object r6 = r4.get(r5)     // Catch:{ all -> 0x00ee }
                com.google.common.collect.MapMakerInternalMap$ReferenceEntry r6 = (com.google.common.collect.MapMakerInternalMap.ReferenceEntry) r6     // Catch:{ all -> 0x00ee }
                r7 = r6
            L_0x003a:
                if (r7 == 0) goto L_0x00a2
                java.lang.Object r8 = r7.getKey()     // Catch:{ all -> 0x00ee }
                int r9 = r7.getHash()     // Catch:{ all -> 0x00ee }
                if (r9 != r13) goto L_0x009d
                if (r8 == 0) goto L_0x009d
                com.google.common.collect.MapMakerInternalMap r9 = r11.map     // Catch:{ all -> 0x00ee }
                com.google.common.base.Equivalence<java.lang.Object> r9 = r9.keyEquivalence     // Catch:{ all -> 0x00ee }
                boolean r9 = r9.equivalent(r12, r8)     // Catch:{ all -> 0x00ee }
                if (r9 == 0) goto L_0x009d
                com.google.common.collect.MapMakerInternalMap$ValueReference r9 = r7.getValueReference()     // Catch:{ all -> 0x00ee }
                boolean r9 = r9.isComputingReference()     // Catch:{ all -> 0x00ee }
                if (r9 == 0) goto L_0x005e
                r3 = 0
                goto L_0x00a3
            L_0x005e:
                com.google.common.collect.MapMakerInternalMap$ValueReference r9 = r7.getValueReference()     // Catch:{ all -> 0x00ee }
                java.lang.Object r9 = r9.get()     // Catch:{ all -> 0x00ee }
                if (r9 != 0) goto L_0x006e
                com.google.common.collect.MapMaker$RemovalCause r10 = com.google.common.collect.MapMaker.RemovalCause.COLLECTED     // Catch:{ all -> 0x00ee }
                r11.enqueueNotification(r8, r13, r9, r10)     // Catch:{ all -> 0x00ee }
                goto L_0x0083
            L_0x006e:
                com.google.common.collect.MapMakerInternalMap r10 = r11.map     // Catch:{ all -> 0x00ee }
                boolean r10 = r10.expires()     // Catch:{ all -> 0x00ee }
                if (r10 == 0) goto L_0x0090
                com.google.common.collect.MapMakerInternalMap r10 = r11.map     // Catch:{ all -> 0x00ee }
                boolean r10 = r10.isExpired(r7)     // Catch:{ all -> 0x00ee }
                if (r10 == 0) goto L_0x0090
                com.google.common.collect.MapMaker$RemovalCause r10 = com.google.common.collect.MapMaker.RemovalCause.EXPIRED     // Catch:{ all -> 0x00ee }
                r11.enqueueNotification(r8, r13, r9, r10)     // Catch:{ all -> 0x00ee }
            L_0x0083:
                java.util.Queue r8 = r11.evictionQueue     // Catch:{ all -> 0x00ee }
                r8.remove(r7)     // Catch:{ all -> 0x00ee }
                java.util.Queue r8 = r11.expirationQueue     // Catch:{ all -> 0x00ee }
                r8.remove(r7)     // Catch:{ all -> 0x00ee }
                r11.count = r3     // Catch:{ all -> 0x00ee }
                goto L_0x00a2
            L_0x0090:
                r11.recordLockedRead(r7)     // Catch:{ all -> 0x00ee }
                r11.unlock()     // Catch:{ all -> 0x00f6 }
                r11.postWriteCleanup()     // Catch:{ all -> 0x00f6 }
                r11.postReadCleanup()
                return r9
            L_0x009d:
                com.google.common.collect.MapMakerInternalMap$ReferenceEntry r7 = r7.getNext()     // Catch:{ all -> 0x00ee }
                goto L_0x003a
            L_0x00a2:
                r3 = 1
            L_0x00a3:
                if (r3 == 0) goto L_0x00bf
                com.google.common.collect.ComputingConcurrentHashMap$ComputingValueReference r0 = new com.google.common.collect.ComputingConcurrentHashMap$ComputingValueReference     // Catch:{ all -> 0x00ee }
                r0.<init>(r14)     // Catch:{ all -> 0x00ee }
                if (r7 != 0) goto L_0x00b9
                com.google.common.collect.MapMakerInternalMap$ReferenceEntry r6 = r11.newEntry(r12, r13, r6)     // Catch:{ all -> 0x00ee }
                r6.setValueReference(r0)     // Catch:{ all -> 0x00ee }
                r4.set(r5, r6)     // Catch:{ all -> 0x00ee }
                r4 = r0
                r0 = r6
                goto L_0x00c1
            L_0x00b9:
                r7.setValueReference(r0)     // Catch:{ all -> 0x00ee }
                r4 = r0
                r0 = r7
                goto L_0x00c1
            L_0x00bf:
            ...
            L_0x00c1:
                ...
                r11.postWriteCleanup()     // Catch:{ all -> 0x00f6 }
                if (r3 == 0) goto L_0x00d1
                java.lang.Object r12 = r11.compute(r12, r13, r0, r4)     // Catch:{ all -> 0x00f6 }
                r11.postReadCleanup()
                return r12
            L_0x00d1:
                boolean r3 = java.lang.Thread.holdsLock(r0)     // Catch:{ all -> 0x00f6 }

...
public abstract class ImmutableBiMap<K, V> extends ImmutableMap<K, V> implements BiMap<K, V> {
    ...
    public static final class Builder<K, V> extends com.google.common.collect.ImmutableMap.Builder<K, V> {
        ...
        public ImmutableBiMap<K, V> build() {
            switch (this.size) {
                ...
                case 1:
                    return ImmutableBiMap.m60of(this.entries[0].getKey(), this.entries[0].getValue());
                default:
    ...
    /* renamed from: of */
    public static <K, V> ImmutableBiMap<K, V> m59of() {
        return EmptyImmutableBiMap.INSTANCE;
    }

    /* renamed from: of */
    public static <K, V> ImmutableBiMap<K, V> m60of(K k, V v) {
        return new SingletonImmutableBiMap(k, v);
    }

    /* renamed from: of */
    public static <K, V> ImmutableBiMap<K, V> m61of(K k, V v, K k2, V v2) {
        return new RegularImmutableBiMap((TerminalEntry<?, ?>[]) new TerminalEntry[]{entryOf(k, v), entryOf(k2, v2)});
    }

    /* renamed from: of */
    public static <K, V> ImmutableBiMap<K, V> m62of(K k, V v, K k2, V v2, K k3, V v3) {
        return new RegularImmutableBiMap((TerminalEntry<?, ?>[]) new TerminalEntry[]{entryOf(k, v), entryOf(k2, v2), entryOf(k3, v3)});
    }

    /* renamed from: of */
    public static <K, V> ImmutableBiMap<K, V> m63of(K k, V v, K k2, V v2, K k3, V v3, K k4, V v4) {
        return new RegularImmutableBiMap((TerminalEntry<?, ?>[]) new TerminalEntry[]{entryOf(k, v), entryOf(k2, v2), entryOf(k3, v3), entryOf(k4, v4)});
    }

    /* renamed from: of */
    public static <K, V> ImmutableBiMap<K, V> m64of(K k, V v, K k2, V v2, K k3, V v3, K k4, V v4, K k5, V v5) {
    ...
    public static <K, V> ImmutableBiMap<K, V> copyOf(Map<? extends K, ? extends V> map) {
        ...
        switch (entryArr.length) {
            ...
            case 1:
                ...
                return m60of(entry.getKey(), entry.getValue());
            default:

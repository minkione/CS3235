...
class FilteredEntryMultimap<K, V> extends AbstractMultimap<K, V> implements FilteredMultimap<K, V> {
    ...
    class AsMap extends ImprovedAbstractMap<K, Collection<V>> {
        ...
        public Set<K> createKeySet() {
            return new KeySet<K, Collection<V>>(this) {
                public boolean removeAll(Collection<?> collection) {
                    return FilteredEntryMultimap.this.removeIf(Maps.keyPredicateOnEntries(Predicates.m45in(collection)));
                }

                public boolean retainAll(Collection<?> collection) {
                    return FilteredEntryMultimap.this.removeIf(Maps.keyPredicateOnEntries(Predicates.not(Predicates.m45in(collection))));
                }
        ...
        public Set<Entry<K, Collection<V>>> createEntrySet() {
            return new EntrySet<K, Collection<V>>() {
                ...
                public boolean removeAll(Collection<?> collection) {
                    return FilteredEntryMultimap.this.removeIf(Predicates.m45in(collection));
                }

                public boolean retainAll(Collection<?> collection) {
                    return FilteredEntryMultimap.this.removeIf(Predicates.not(Predicates.m45in(collection)));
                }
        ...
        public Collection<Collection<V>> createValues() {
            return new Values<K, Collection<V>>(this) {
                ...
                public boolean removeAll(Collection<?> collection) {
                    return FilteredEntryMultimap.this.removeIf(Maps.valuePredicateOnEntries(Predicates.m45in(collection)));
                }

                public boolean retainAll(Collection<?> collection) {
                    return FilteredEntryMultimap.this.removeIf(Maps.valuePredicateOnEntries(Predicates.not(Predicates.m45in(collection))));
                }
            };
        }
    }
    ...
    class Keys extends Keys<K, V> {
        ...
        public Set<Multiset.Entry<K>> entrySet() {
            return new EntrySet<K>() {
                ...
                public boolean removeAll(Collection<?> collection) {
                    return removeIf(Predicates.m45in(collection));
                }

                public boolean retainAll(Collection<?> collection) {
                    return removeIf(Predicates.not(Predicates.m45in(collection)));
                }
            };
        }
    }
    ...
    /* access modifiers changed from: 0000 */
    public boolean removeIf(Predicate<? super Entry<K, Collection<V>>> predicate2) {

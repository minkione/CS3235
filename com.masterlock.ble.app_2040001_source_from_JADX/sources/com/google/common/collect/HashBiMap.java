            ...
            return new Itr<Entry<K, V>>() {
                ...
                class MapEntry extends AbstractMapEntry<K, V> {
                    ...
                    public V setValue(V v) {
                        ...
                        C06021 r7 = C06021.this;
                        r7.expectedModCount = HashBiMap.this.modCount;
                        if (C06021.this.toRemove == this.delegate) {
                            C06021.this.toRemove = biEntry;
                        }
                        this.delegate = biEntry;
                        return v2;
                    }

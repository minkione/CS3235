...
class StandardTable<R, C, V> extends AbstractTable<R, C, V> implements Serializable {
    ...
    private class Column extends ImprovedAbstractMap<R, V> {
        ...
        private class EntrySet extends ImprovedAbstractSet<Entry<R, V>> {
            ...
            public void clear() {
                Column.this.removeIf(Predicates.alwaysTrue());
            }
            ...
            public boolean retainAll(Collection<?> collection) {
                return Column.this.removeIf(Predicates.not(Predicates.m45in(collection)));
            }
        }
        ...
        private class KeySet extends KeySet<R, V> {
            ...
            public boolean retainAll(Collection<?> collection) {
                return Column.this.removeIf(Maps.keyPredicateOnEntries(Predicates.not(Predicates.m45in(collection))));
            }
        }
        ...
        private class Values extends Values<R, V> {
            ...
            public boolean remove(Object obj) {
                return obj != null && Column.this.removeIf(Maps.valuePredicateOnEntries(Predicates.equalTo(obj)));
            }

            public boolean removeAll(Collection<?> collection) {
                return Column.this.removeIf(Maps.valuePredicateOnEntries(Predicates.m45in(collection)));
            }

            public boolean retainAll(Collection<?> collection) {
                return Column.this.removeIf(Maps.valuePredicateOnEntries(Predicates.not(Predicates.m45in(collection))));
            }
        }
        ...
        public boolean removeIf(Predicate<? super Entry<R, V>> predicate) {

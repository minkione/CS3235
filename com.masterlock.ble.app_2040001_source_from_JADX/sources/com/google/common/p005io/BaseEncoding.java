...
public abstract class BaseEncoding {
    ...
    static final class StandardBaseEncoding extends BaseEncoding {
        ...
        public CharMatcher padding() {
            ...
            return ch == null ? CharMatcher.NONE : CharMatcher.m33is(ch.charValue());
        }
        ...
        public BaseEncoding withSeparator(String str, int i) {
            ...
            Preconditions.checkArgument(padding().mo12196or(this.alphabet).matchesNoneOf(str), "Separator cannot contain alphabet or padding characters");
    ...
    @GwtIncompatible("Writer,OutputStream")
    @Deprecated
    public final OutputSupplier<OutputStream> encodingStream(final OutputSupplier<? extends Writer> outputSupplier) {
        Preconditions.checkNotNull(outputSupplier);
        return new OutputSupplier<OutputStream>() {
            public OutputStream getOutput() throws IOException {
                return BaseEncoding.this.encodingStream((Writer) outputSupplier.getOutput());
            }
        };
    }
    ...
    @GwtIncompatible("Reader,InputStream")
    @Deprecated
    public final InputSupplier<InputStream> decodingStream(final InputSupplier<? extends Reader> inputSupplier) {
        Preconditions.checkNotNull(inputSupplier);
        return new InputSupplier<InputStream>() {
            public InputStream getInput() throws IOException {
                return BaseEncoding.this.decodingStream((Reader) inputSupplier.getInput());
            }
        };
    }

...
public class CycleDetectingLockFactory {
    ...
    private static class ExampleStackTrace extends IllegalStateException {
        ...
        static Set<String> EXCLUDED_CLASS_NAMES = ImmutableSet.m110of(CycleDetectingLockFactory.class.getName(), ExampleStackTrace.class.getName(), LockGraphNode.class.getName());
    ...
    private static class LockGraphNode {
        ...
        public void checkAcquiredLock(Policy policy, LockGraphNode lockGraphNode) {
            ...
            StringBuilder sb = new StringBuilder();
            sb.append("Attempted to acquire multiple locks with the same rank ");
            sb.append(lockGraphNode.getLockName());
    ...
    private static Map<? extends Enum, LockGraphNode> getOrCreateNodes(Class<? extends Enum> cls) {
        ...
        return (Map) Objects.firstNonNull((Map) lockGraphNodesPerType.putIfAbsent(cls, createNodes), createNodes);
    }
    ...
    /* access modifiers changed from: private */
    public void lockStateChanged(CycleDetectingLock cycleDetectingLock) {
        if (!cycleDetectingLock.isAcquiredByCurrentThread()) {
            ArrayList arrayList = (ArrayList) acquiredLocks.get();
            LockGraphNode lockGraphNode = cycleDetectingLock.getLockGraphNode();

...
public final class MediaType {
    ...
    public static final MediaType APPLICATION_BINARY = createConstant(APPLICATION_TYPE, MultipartTypedOutput.DEFAULT_TRANSFER_ENCODING);
    ...
    private static final MapJoiner PARAMETER_JOINER = Joiner.m40on("; ").withKeyValueSeparator("=");
    ...
    private static final ImmutableListMultimap<String, String> UTF_8_CONSTANT_PARAMETERS = ImmutableListMultimap.m79of("charset", Ascii.toLowerCase(Charsets.UTF_8.name()));
    ...
    private static MediaType createConstant(String str, String str2) {
        return addKnownType(new MediaType(str, str2, ImmutableListMultimap.m78of()));
    }
    ...
    public Optional<Charset> charset() {
        ImmutableSet copyOf = ImmutableSet.copyOf((Collection<? extends E>) this.parameters.get((Object) "charset"));
        switch (copyOf.size()) {
            case 0:
                return Optional.absent();
            case 1:
                return Optional.m41of(Charset.forName((String) Iterables.getOnlyElement(copyOf)));
            default:
    ...
    /* renamed from: is */
    public boolean mo15311is(MediaType mediaType) {
    ...
    public static MediaType create(String str, String str2) {
        return create(str, str2, ImmutableListMultimap.m78of());
    }

...
public final class BigIntegerMath {
    ...
    static /* synthetic */ class C08671 {
        ...
        static {
            ...
            L_0x0062:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.google.common.math.BigIntegerMath.C08671.<clinit>():void");
        }
    }
    ...
    public static int log2(BigInteger bigInteger, RoundingMode roundingMode) {
        ...
        switch (C08671.$SwitchMap$java$math$RoundingMode[roundingMode.ordinal()]) {
            case 1:
    ...
    public static BigInteger sqrt(BigInteger bigInteger, RoundingMode roundingMode) {
        ...
        switch (C08671.$SwitchMap$java$math$RoundingMode[roundingMode.ordinal()]) {
            ...
            case 4:
            case 5:
                if (!sqrtFloor.pow(2).equals(bigInteger)) {

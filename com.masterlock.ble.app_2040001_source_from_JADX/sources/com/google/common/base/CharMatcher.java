...
public abstract class CharMatcher implements Predicate<Character> {
    public static final CharMatcher ANY = new FastMatcher("CharMatcher.ANY") {
        ...
        /* renamed from: or */
        public CharMatcher mo12196or(CharMatcher charMatcher) {
    ...
    public static final CharMatcher JAVA_ISO_CONTROL = inRange(0, 31).mo12196or(inRange(Ascii.MAX, 159)).withToString("CharMatcher.JAVA_ISO_CONTROL");
    ...
    public static final CharMatcher WHITESPACE = new FastMatcher("CharMatcher.WHITESPACE") {
        public boolean matches(char c) {
            return CharMatcher.WHITESPACE_TABLE.charAt(c % 'O') == c;
        }
    };
    ...
    private static class C0497Or extends CharMatcher {
        final CharMatcher first;
        final CharMatcher second;
        ...
        C0497Or(CharMatcher charMatcher, CharMatcher charMatcher2, String str) {
            super(str);
            this.first = (CharMatcher) Preconditions.checkNotNull(charMatcher);
            this.second = (CharMatcher) Preconditions.checkNotNull(charMatcher2);
        }

        C0497Or(CharMatcher charMatcher, CharMatcher charMatcher2) {
            StringBuilder sb = new StringBuilder();
        ...
        /* access modifiers changed from: 0000 */
        public CharMatcher withToString(String str) {
            return new C0497Or(this.first, this.second, str);
        }
    }
    ...
    /* renamed from: is */
    public static CharMatcher m33is(final char c) {
        StringBuilder sb = new StringBuilder();
        ...
        return new FastMatcher(sb.toString()) {
            ...
            /* renamed from: or */
            public CharMatcher mo12196or(CharMatcher charMatcher) {
                return charMatcher.matches(c) ? charMatcher : super.mo12196or(charMatcher);
            }
    ...
    public static CharMatcher anyOf(CharSequence charSequence) {
        switch (charSequence.length()) {
            case 0:
                return NONE;
            case 1:
                return m33is(charSequence.charAt(0));
            case 2:
    ...
    /* renamed from: or */
    public CharMatcher mo12196or(CharMatcher charMatcher) {
        return new C0497Or(this, (CharMatcher) Preconditions.checkNotNull(charMatcher));
    }
    ...
    private static CharMatcher precomputedPositive(int i, BitSet bitSet, String str) {
        switch (i) {
            case 0:
                return NONE;
            case 1:
                return m33is((char) bitSet.nextSetBit(0));
            case 2:

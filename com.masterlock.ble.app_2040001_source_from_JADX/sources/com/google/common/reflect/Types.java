...
final class Types {
    ...
    public static final Joiner COMMA_JOINER = Joiner.m40on(", ").useForNull("null");
    /* access modifiers changed from: private */
    ...
    private static final class ParameterizedTypeImpl implements ParameterizedType, Serializable {
        ...
        public String toString() {
            ...
            if (type != null) {
                sb.append(Types.toString(type));
                sb.append('.');
            }
            sb.append(this.rawType.getName());
            sb.append('<');
            sb.append(Types.COMMA_JOINER.join(Iterables.transform(this.argumentsList, Types.TYPE_TO_STRING)));
            sb.append('>');
            return sb.toString();
        }
    ...
    static final class WildcardTypeImpl implements WildcardType, Serializable {
        ...
        public String toString() {
            ...
            for (Type type2 : Types.filterUpperBounds(this.upperBounds)) {
                sb.append(" extends ");
                sb.append(Types.toString(type2));
            }
            return sb.toString();
        }
    }

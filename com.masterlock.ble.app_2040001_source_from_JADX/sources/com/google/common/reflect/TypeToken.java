...
public abstract class TypeToken<T> extends TypeCapture<T> implements Serializable {
    ...
    private static abstract class TypeCollector<K> {
        ...
        public final ImmutableList<K> collectTypes(K k) {
            return collectTypes((Iterable<? extends K>) ImmutableList.m66of(k));
        }
    ...
    protected TypeToken(Class<?> cls) {
        ...
        if (capture instanceof Class) {
            ...
            this.runtimeType = m162of(cls).resolveType(capture).runtimeType;
        }
    }
    ...
    /* renamed from: of */
    public static <T> TypeToken<T> m162of(Class<T> cls) {
        return new SimpleTypeToken(cls);
    }

    /* renamed from: of */
    public static TypeToken<?> m163of(Type type) {
    ...
    public final <X> TypeToken<T> where(TypeParameter<X> typeParameter, TypeToken<X> typeToken) {
        return new SimpleTypeToken(new TypeResolver().where(ImmutableMap.m85of(typeParameter.typeVariable, typeToken.runtimeType)).resolveType(this.runtimeType));
    }

    public final <X> TypeToken<T> where(TypeParameter<X> typeParameter, Class<X> cls) {
        return where(typeParameter, m162of(cls));
    }
    ...
    public final TypeToken<?> resolveType(Type type) {
        ...
        return m163of(typeResolver2.resolveType(type));
    }
    ...
    private TypeToken<? super T> boundAsSuperclass(Type type) {
        TypeToken<? super T> of = m163of(type);
    ...
    public final TypeToken<? extends T> getSubtype(Class<?> cls) {
        ...
        return m163of(resolveTypeArgsForSubclass(cls));
    }
    ...
    public final TypeToken<T> wrap() {
        return isPrimitive() ? m162of(Primitives.wrap((Class) this.runtimeType)) : this;
    }
    ...
    public final TypeToken<T> unwrap() {
        return isWrapper() ? m162of(Primitives.unwrap((Class) this.runtimeType)) : this;
    }
    ...
    public final TypeToken<?> getComponentType() {
        ...
        return m163of(componentType);
    }

    public final Invokable<T, Object> method(Method method) {
        Preconditions.checkArgument(m162of(method.getDeclaringClass()).isAssignableFrom(this), "%s not declared by %s", method, this);
    ...
    public Object writeReplace() {
        return m163of(new TypeResolver().resolveType(this.runtimeType));
    }
    ...
    static <T> TypeToken<? extends T> toGenericType(Class<T> cls) {
        if (cls.isArray()) {
            return m163of(Types.newArrayType(toGenericType(cls.getComponentType()).runtimeType));
        }
        TypeVariable[] typeParameters = cls.getTypeParameters();
        if (typeParameters.length > 0) {
            return m163of((Type) Types.newParameterizedType(cls, typeParameters));
        }
        return m162of(cls);
    }
    ...
    private TypeToken<? super T> getSupertypeFromUpperBounds(Class<? super T> cls, Type[] typeArr) {
        for (Type of : typeArr) {
            TypeToken of2 = m163of(of);
            if (m162of(cls).isAssignableFrom(of2)) {
    ...
    private TypeToken<? extends T> getSubtypeFromLowerBounds(Class<?> cls, Type[] typeArr) {
        if (typeArr.length > 0) {
            return m163of(typeArr[0]).getSubtype(cls);
        }
        StringBuilder sb = new StringBuilder();
        sb.append(cls);
    ...
    private TypeToken<? super T> getArraySupertype(Class<? super T> cls) {
        return m163of(newArrayClassOrGenericArrayType(((TypeToken) Preconditions.checkNotNull(getComponentType(), "%s isn't a super type of %s", cls, this)).getSupertype(cls.getComponentType()).runtimeType));
    }

    private TypeToken<? extends T> getArraySubtype(Class<?> cls) {
        return m163of(newArrayClassOrGenericArrayType(getComponentType().getSubtype(cls.getComponentType()).runtimeType));
    }

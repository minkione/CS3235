...
public final class SpdyStream {
    ...
    final class SpdyDataSink implements Sink {
        ...
        private void emitDataFrame(boolean z) throws IOException {
            ...
            SpdyStream.this.connection.writeData(SpdyStream.this.f201id, z && min == this.sendBuffer.size(), this.sendBuffer, min);
        }
        ...
        /* JADX WARNING: Code restructure failed: missing block: B:15:0x002d, code lost:
            com.squareup.okhttp.internal.spdy.SpdyStream.access$500(r8.this$0).writeData(com.squareup.okhttp.internal.spdy.SpdyStream.access$600(r8.this$0), true, null, 0);
         */
        ...
        /* JADX WARNING: Code restructure failed: missing block: B:21:0x0046, code lost:
            ...
            com.squareup.okhttp.internal.spdy.SpdyStream.access$1000(r8.this$0);
         */
    ...
    private final class SpdyDataSource implements Source {
        ...
        /* JADX WARNING: Code restructure failed: missing block: B:17:?, code lost:
            r2 = com.squareup.okhttp.internal.spdy.SpdyStream.access$500(r8.this$0);
            r2.unacknowledgedBytesRead += r9;
         */
        /* JADX WARNING: Code restructure failed: missing block: B:18:0x0090, code lost:
            if (com.squareup.okhttp.internal.spdy.SpdyStream.access$500(r8.this$0).unacknowledgedBytesRead < ((long) (com.squareup.okhttp.internal.spdy.SpdyStream.access$500(r8.this$0).okHttpSettings.getInitialWindowSize(65536) / 2))) goto L_0x00ac;
         */
        ...
        public long read(okio.Buffer r9, long r10) throws java.io.IOException {
            ...
            L_0x001d:
                ...
                com.squareup.okhttp.internal.spdy.Settings r11 = r11.okHttpSettings     // Catch:{ all -> 0x00b1 }
                ...
                int r3 = r3.f201id     // Catch:{ all -> 0x00b1 }
            ...
            L_0x0064:
                ...
                com.squareup.okhttp.internal.spdy.Settings r4 = r4.okHttpSettings     // Catch:{ all -> 0x00ae }
        ...
        private void checkNotClosed() throws IOException {
            if (this.closed) {
                ...
                sb.append(SpdyStream.this.errorCode);
    ...
    public boolean isLocallyInitiated() {
        if (this.connection.client == ((this.f201id & 1) == 1)) {
            return true;
        }
        return false;
    }
    ...
    public void reply(List<Header> list, boolean z) throws IOException {
        ...
        this.connection.writeSynReply(this.f201id, z2, list);
        if (z2) {
    ...
    public void close(ErrorCode errorCode2) throws IOException {
        if (closeInternal(errorCode2)) {
            this.connection.writeSynReset(this.f201id, errorCode2);
        }
    }

    public void closeLater(ErrorCode errorCode2) {
        if (closeInternal(errorCode2)) {
            this.connection.writeSynResetLater(this.f201id, errorCode2);
        }
    }
    ...
    private boolean closeInternal(ErrorCode errorCode2) {
        synchronized (this) {
            ...
            notifyAll();
            this.connection.removeStream(this.f201id);
            return true;
        }
    }

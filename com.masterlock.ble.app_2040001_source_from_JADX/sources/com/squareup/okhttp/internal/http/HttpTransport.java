...
public final class HttpTransport implements Transport {
    ...
    public boolean canReuseConnection() {
        if (!"close".equalsIgnoreCase(this.httpEngine.getRequest().header(HttpHeaders.CONNECTION)) && !"close".equalsIgnoreCase(this.httpEngine.getResponse().header(HttpHeaders.CONNECTION)) && !this.httpConnection.isClosed()) {
            return true;
        }
        return false;
    }

...
import com.squareup.okhttp.internal.p006io.FileSystem;
...
public final class Cache {
    ...
    private static final class Entry {
        ...
        private void writeCertList(BufferedSink bufferedSink, List<Certificate> list) throws IOException {
            try {
                ...
                int size = list.size();
                for (int i = 0; i < size; i++) {
                    bufferedSink.writeUtf8(ByteString.m205of(((Certificate) list.get(i)).getEncoded()).base64());
                    bufferedSink.writeByte(10);
                }
    ...
    public CacheRequest put(Response response) throws IOException {
        ...
        if (HttpMethod.invalidatesCache(response.request().method())) {
            ...
            return null;
        } else if (!method.equals(HttpRequest.METHOD_GET) || OkHeaders.hasVaryAll(response)) {
            return null;
        } else {

package p008io.fabric.sdk.android.services.persistence;
...
public class FileStoreImpl implements FileStore {
    ...
    public File prepare(File file) {
        if (file == null) {
            Fabric.getLogger().mo21793d(Fabric.TAG, "Null File");
        } else if (file.exists() || file.mkdirs()) {
            return file;
        } else {
            Fabric.getLogger().mo21806w(Fabric.TAG, "Couldn't create file");
        }
        return null;
    }
    ...
    public boolean isExternalStorageAvailable() {
        ...
        Fabric.getLogger().mo21806w(Fabric.TAG, "External Storage is not mounted and/or writable\nHave you declared android.permission.WRITE_EXTERNAL_STORAGE in the manifest?");
        return false;
    }
}

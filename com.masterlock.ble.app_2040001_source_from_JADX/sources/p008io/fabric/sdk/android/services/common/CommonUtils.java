...
public class CommonUtils {
    ...
    enum Architecture {
        ...
        static Architecture getValue() {
            ...
            if (TextUtils.isEmpty(str)) {
                Fabric.getLogger().mo21793d(Fabric.TAG, "Architecture#getValue()::Build.CPU_ABI returned null or empty");
                return UNKNOWN;
            }
    ...
    public static String extractFieldFromSystemFile(File file, String str) {
        ...
        if (file.exists()) {
            try {
                ...
                while (true) {
                    try {
                        ...
                        try {
                            ...
                            sb.append(file);
                            logger.mo21796e(str3, sb.toString(), e);
                ...
                sb2.append(file);
                logger2.mo21796e(str32, sb2.toString(), e);
                closeOrLog(bufferedReader, "Failed to close system file reader.");
                return str2;
            } catch (Throwable th2) {
                th = th2;
    ...
    private static String hash(InputStream inputStream, String str) {
        try {
            ...
            Fabric.getLogger().mo21796e(Fabric.TAG, "Could not calculate hash for app icon.", e);
            return "";
        }
    }
    ...
    private static String hash(byte[] bArr, String str) {
        try {
            ...
            logger.mo21796e(str2, sb.toString(), e);
            return "";
        }
    }
    ...
    public static void logControlled(Context context, String str) {
        if (isClsTrace(context)) {
            Fabric.getLogger().mo21793d(Fabric.TAG, str);
        }
    }

    public static void logControlledError(Context context, String str, Throwable th) {
        if (isClsTrace(context)) {
            Fabric.getLogger().mo21795e(Fabric.TAG, str);
        }
    }
    ...
    public static void closeOrLog(Closeable closeable, String str) {
        if (closeable != null) {
            try {
                ...
                Fabric.getLogger().mo21796e(Fabric.TAG, str, e);
            }
        }
    }
    ...
    public static void logOrThrowIllegalStateException(String str, String str2) {
        if (!Fabric.isDebuggable()) {
            Fabric.getLogger().mo21806w(str, str2);
            return;
        }

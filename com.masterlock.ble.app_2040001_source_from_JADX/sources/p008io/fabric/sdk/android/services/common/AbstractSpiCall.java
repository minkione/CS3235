...
public abstract class AbstractSpiCall {
    ...
    public HttpRequest getHttpRequest(Map<String, String> map) {
        ...
        return this.requestFactory.buildHttpRequest(this.method, getUrl(), map).useCaches(false).connectTimeout(10000).header("User-Agent", sb.toString()).header(HEADER_DEVELOPER_TOKEN, "470fa2b4ae81cd56ecbcda9735803434cec591fa");
    }

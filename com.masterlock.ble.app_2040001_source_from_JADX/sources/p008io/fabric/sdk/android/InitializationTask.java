...
import p008io.fabric.sdk.android.services.common.TimingMetric;
import p008io.fabric.sdk.android.services.concurrency.Priority;
import p008io.fabric.sdk.android.services.concurrency.PriorityAsyncTask;
...
class InitializationTask<Result> extends PriorityAsyncTask<Void, Void, Result> {
    ...
    public void onPreExecute() {
        ...
        try {
            ...
            Fabric.getLogger().mo21796e(Fabric.TAG, "Failure onPreExecute()", e2);
            createAndStartTimingMetric.stopMeasuring();
        } catch (Throwable th) {
            createAndStartTimingMetric.stopMeasuring();
            cancel(true);

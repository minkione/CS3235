...
public abstract class SQLiteProgram extends SQLiteClosable {
    ...
    SQLiteProgram(SQLiteDatabase sQLiteDatabase, String str) {
        ...
        if (substring.equalsIgnoreCase("INSERT") || substring.equalsIgnoreCase("UPDATE") || substring.equalsIgnoreCase("REPLAC") || substring.equalsIgnoreCase(HttpRequest.METHOD_DELETE) || substring.equalsIgnoreCase("SELECT")) {

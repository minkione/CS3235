...
public class SQLiteDatabase extends SQLiteClosable {
    ...
    public void setForeignKeyConstraintsEnabled(boolean z) {
        if (!inTransaction()) {
            String str = "PRAGMA foreign_keys = %s;";
            Object[] objArr = new Object[1];
            objArr[0] = z ? "ON" : "OFF";
            execSQL(String.format(str, objArr));
            return;
        }
    ...
    public long insertWithOnConflict(java.lang.String r5, java.lang.String r6, android.content.ContentValues r7, int r8) {
        ...
        L_0x008b:
            ...
            r0.append(r5)
            r4.lock()
            java.lang.String r5 = r0.toString()     // Catch:{ SQLiteDatabaseCorruptException -> 0x00da }
            net.sqlcipher.database.SQLiteStatement r2 = r4.compileStatement(r5)     // Catch:{ SQLiteDatabaseCorruptException -> 0x00da }
            if (r6 == 0) goto L_0x00bf
            int r5 = r6.size()     // Catch:{ SQLiteDatabaseCorruptException -> 0x00da }
            java.util.Iterator r6 = r6.iterator()     // Catch:{ SQLiteDatabaseCorruptException -> 0x00da }
        L_0x00ad:
            if (r1 >= r5) goto L_0x00bf
            java.lang.Object r7 = r6.next()     // Catch:{ SQLiteDatabaseCorruptException -> 0x00da }
            java.util.Map$Entry r7 = (java.util.Map.Entry) r7     // Catch:{ SQLiteDatabaseCorruptException -> 0x00da }
            int r1 = r1 + 1
            java.lang.Object r7 = r7.getValue()     // Catch:{ SQLiteDatabaseCorruptException -> 0x00da }
            net.sqlcipher.DatabaseUtils.bindObjectToProgram(r2, r1, r7)     // Catch:{ SQLiteDatabaseCorruptException -> 0x00da }
            goto L_0x00ad
        L_0x00bf:
            r2.execute()     // Catch:{ SQLiteDatabaseCorruptException -> 0x00da }
            int r5 = r4.lastChangeCount()     // Catch:{ SQLiteDatabaseCorruptException -> 0x00da }
            if (r5 <= 0) goto L_0x00cd
            long r5 = r4.lastInsertRow()     // Catch:{ SQLiteDatabaseCorruptException -> 0x00da }
            goto L_0x00cf
        L_0x00cd:
            r5 = -1
        L_0x00cf:
        ...
        L_0x00da:
            r5 = move-exception
            r4.onCorruption()     // Catch:{ all -> 0x00d8 }

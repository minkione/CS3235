...
public final class Weeks extends BaseSingleFieldPeriod {
    ...
    public static Weeks standardWeeksIn(ReadablePeriod readablePeriod) {
        return weeks(BaseSingleFieldPeriod.standardPeriodIn(readablePeriod, FirmwareUpdateService.NOTIFY_INTERVAL));
    }
    ...
    public Duration toStandardDuration() {
        return new Duration(((long) getValue()) * FirmwareUpdateService.NOTIFY_INTERVAL);
    }

...
public final class ClassPath {
    ...
    public static final Splitter CLASS_PATH_ATTRIBUTE_SEPARATOR = Splitter.m54on(" ").omitEmptyStrings();
    /* access modifiers changed from: private */
    ...
    public static class ResourceInfo {
        ...
        /* renamed from: of */
        static ResourceInfo m160of(String str, ClassLoader classLoader) {
            if (!str.endsWith(ClassPath.CLASS_FILE_NAME_EXTENSION) || str.contains("$")) {
    ...
    static final class Scanner {
        ...
        private void scanDirectory(File file, ClassLoader classLoader) throws IOException {
            scanDirectory(file, classLoader, "", ImmutableSet.m107of());
        }
                ...
                for (File file2 : listFiles) {
                    ...
                    if (file2.isDirectory()) {
                        ...
                        if (!sb4.equals("META-INF/MANIFEST.MF")) {
                            this.resources.add((Object) ResourceInfo.m160of(sb4, classLoader));
                        }
                    }
                }
            }
                    ...
                    while (entries.hasMoreElements()) {
                        ...
                        if (!jarEntry.isDirectory()) {
                            if (!jarEntry.getName().equals("META-INF/MANIFEST.MF")) {
                                this.resources.add((Object) ResourceInfo.m160of(jarEntry.getName(), classLoader));
                            }
                        }
                    }
                } finally {

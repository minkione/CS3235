    ...
    private static class CombinedFuture<V, C> extends AbstractFuture<C> {
        ...
        public void init(Executor executor) {
            ...
            if (this.futures.isEmpty()) {
                set(this.combiner.combine(ImmutableList.m65of()));
                return;
            }
            final int i = 0;
        ...
        private void setExceptionAndMaybeLog(Throwable th) {
            boolean exception = this.allMustSucceed ? super.setException(th) : false;
            if ((th instanceof Error) || (this.allMustSucceed && !exception)) {

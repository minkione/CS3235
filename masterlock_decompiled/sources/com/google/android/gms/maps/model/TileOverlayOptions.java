...
public final class TileOverlayOptions extends AbstractSafeParcelable {
    ...
    @Field(getter = "getZIndex", mo9239id = 4)
    private float zzcs;
    @Field(getter = "isVisible", mo9239id = 3)
    private boolean zzct = true;
    @Field(getter = "getTransparency", mo9239id = 6)
    private float zzda = 0.0f;
    /* access modifiers changed from: private */
    @Field(getter = "getTileProviderDelegate", mo9239id = 2, type = "android.os.IBinder")
    public zzaf zzei;
    private TileProvider zzej;
    @Field(defaultValue = "true", getter = "getFadeIn", mo9239id = 5)
    ...
    @Constructor
    TileOverlayOptions(@Param(mo9242id = 2) IBinder iBinder, @Param(mo9242id = 3) boolean z, @Param(mo9242id = 4) float f, @Param(mo9242id = 5) boolean z2, @Param(mo9242id = 6) float f2) {
        zzs zzs;

...
public final class StreetViewPanoramaOptions extends AbstractSafeParcelable implements ReflectedParcelable {
    ...
    @Field(getter = "getPanoramaId", mo9239id = 3)
    private String panoId;
    @Field(getter = "getPosition", mo9239id = 4)
    private LatLng position;
    @Field(getter = "getUseViewLifecycleInFragmentForParcel", mo9239id = 10, type = "byte")
    private Boolean zzak;
    @Field(getter = "getZoomGesturesEnabledForParcel", mo9239id = 7, type = "byte")
    private Boolean zzap = Boolean.valueOf(true);
    @Field(getter = "getStreetViewPanoramaCamera", mo9239id = 2)
    private StreetViewPanoramaCamera zzbx;
    @Field(getter = "getRadius", mo9239id = 5)
    private Integer zzby;
    @Field(getter = "getUserNavigationEnabledForParcel", mo9239id = 6, type = "byte")
    private Boolean zzbz = Boolean.valueOf(true);
    @Field(getter = "getPanningGesturesEnabledForParcel", mo9239id = 8, type = "byte")
    private Boolean zzca = Boolean.valueOf(true);
    @Field(getter = "getStreetNamesEnabledForParcel", mo9239id = 9, type = "byte")
    private Boolean zzcb = Boolean.valueOf(true);
    @Field(getter = "getSource", mo9239id = 11)
    private StreetViewSource zzcc = StreetViewSource.DEFAULT;

    @Constructor
    StreetViewPanoramaOptions(@Param(mo9242id = 2) StreetViewPanoramaCamera streetViewPanoramaCamera, @Param(mo9242id = 3) String str, @Param(mo9242id = 4) LatLng latLng, @Param(mo9242id = 5) Integer num, @Param(mo9242id = 6) byte b, @Param(mo9242id = 7) byte b2, @Param(mo9242id = 8) byte b3, @Param(mo9242id = 9) byte b4, @Param(mo9242id = 10) byte b5, @Param(mo9242id = 11) StreetViewSource streetViewSource) {

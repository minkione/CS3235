...
public class ActivityTransitionRequest extends AbstractSafeParcelable {
    ...
    @Nullable
    @Field(getter = "getTag", mo9239id = 2)
    private final String tag;
    @Field(getter = "getActivityTransitions", mo9239id = 1)
    private final List<ActivityTransition> zzl;
    @Field(getter = "getClients", mo9239id = 3)
    ...
    @Constructor
    public ActivityTransitionRequest(@Param(mo9242id = 1) List<ActivityTransition> list, @Nullable @Param(mo9242id = 2) String str, @Nullable @Param(mo9242id = 3) List<ClientIdentity> list2) {

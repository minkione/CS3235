...
public final class ConnectionResult extends AbstractSafeParcelable {
    ...
    @Field(getter = "getErrorCode", mo9239id = 2)
    private final int zzh;
    @Field(getter = "getResolution", mo9239id = 3)
    private final PendingIntent zzi;
    @Field(getter = "getErrorMessage", mo9239id = 4)
    private final String zzj;

    @Constructor
    ConnectionResult(@Param(mo9242id = 1) int i, @Param(mo9242id = 2) int i2, @Param(mo9242id = 3) PendingIntent pendingIntent, @Param(mo9242id = 4) String str) {
        this.zzg = i;
        this.zzh = i2;
            ...
            default:
                switch (i) {
                    case 13:
                        return "CANCELED";
                    case 14:
                        return LockActivity.TIME_OUT_TAG;
                    case 15:
                        return "INTERRUPTED";
                    case 16:

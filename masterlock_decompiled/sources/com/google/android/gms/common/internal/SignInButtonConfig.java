...
public class SignInButtonConfig extends AbstractSafeParcelable {
    ...
    @Field(getter = "getScopes", mo9239id = 4)
    @Deprecated
    private final Scope[] zanx;
    @Field(getter = "getButtonSize", mo9239id = 2)
    private final int zapc;
    @Field(getter = "getColorScheme", mo9239id = 3)
    private final int zapd;

    @Constructor
    SignInButtonConfig(@Param(mo9242id = 1) int i, @Param(mo9242id = 2) int i2, @Param(mo9242id = 3) int i3, @Param(mo9242id = 4) Scope[] scopeArr) {
        this.zale = i;
        this.zapc = i2;
        this.zapd = i3;
        this.zanx = scopeArr;

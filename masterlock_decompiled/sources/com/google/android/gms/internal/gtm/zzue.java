...
final class zzue extends zzub {
    ...
    public final int zzb(CharSequence charSequence, byte[] bArr, int i, int i2) {
        ...
        while (i6 < length) {
            ...
            if (charAt3 < 128 && j < j3) {
                long j5 = j + 1;
                zztx.zza(bArr2, j, (byte) charAt3);
                j = j5;
            } else if (charAt3 < 2048 && j <= j3 - 2) {
                long j6 = j + 1;
                zztx.zza(bArr2, j, (byte) ((charAt3 >>> 6) | 960));
                j = j6 + 1;
                zztx.zza(bArr2, j6, (byte) ((charAt3 & '?') | 128));
            } else if ((charAt3 < 55296 || 57343 < charAt3) && j <= j3 - 3) {
                long j7 = j + 1;
                zztx.zza(bArr2, j, (byte) ((charAt3 >>> 12) | 480));
                long j8 = j7 + 1;
                zztx.zza(bArr2, j7, (byte) (((charAt3 >>> 6) & 63) | 128));
                long j9 = j8 + 1;
                ...
                if (i7 != length) {
                    ...
                    if (Character.isSurrogatePair(charAt3, charAt4)) {
                        ...
                        long j10 = j + 1;
                        zztx.zza(bArr2, j, (byte) ((codePoint >>> 18) | 240));
                        long j11 = j10 + 1;
                        zztx.zza(bArr2, j10, (byte) (((codePoint >>> 12) & 63) | 128));
                        long j12 = j11 + 1;
                        zztx.zza(bArr2, j11, (byte) (((codePoint >>> 6) & 63) | 128));
                        j = j12 + 1;
                        zztx.zza(bArr2, j12, (byte) ((codePoint & 63) | 128));
                        i6 = i7;
                    }
                } else {
                    i7 = i6;
                }
                throw new zzud(i7 - 1, length);
            } else {
        ...
        if (((long) length) <= limit - position) {
            ...
            while (i < length) {
                ...
                if (charAt2 < c && position < limit) {
                    ...
                    long j6 = j5 + j;
                    zztx.zza(j5, (byte) ((charAt2 & '?') | 128));
                    j2 = j6;
                    j3 = j;
                } else if ((charAt2 < 55296 || 57343 < charAt2) && position <= limit - 3) {
                    long j7 = position + j;
                    zztx.zza(position, (byte) ((charAt2 >>> 12) | 480));
                    long j8 = j7 + j;
                    zztx.zza(j7, (byte) (((charAt2 >>> 6) & 63) | 128));
                    long j9 = j8 + 1;
                    ...
                    if (i2 != length) {
                        ...
                        if (Character.isSurrogatePair(charAt2, charAt3)) {
                            ...
                            long j11 = j10 + 1;
                            zztx.zza(j10, (byte) (((codePoint >>> 12) & 63) | 128));
                            long j12 = j11 + 1;
                            zztx.zza(j11, (byte) (((codePoint >>> 6) & 63) | 128));
                            j3 = 1;
                            long j13 = j12 + 1;
                            zztx.zza(j12, (byte) ((codePoint & 63) | 128));
                            i = i2;
                            j2 = j13;
                        } else {
                            i = i2;

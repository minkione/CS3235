...
final class zzut implements Cloneable {
    ...
    public final void zza(zzuy zzuy) throws IOException {
        ...
        if (obj2 instanceof zzuw) {
        ...
        } else if (obj2 instanceof zzuw[]) {
            zzuw[] zzuwArr = (zzuw[]) this.zzbhi.zzag(Collections.singletonList(zzuy));
            zzuw[] zzuwArr2 = (zzuw[]) this.value;
            Object obj3 = (zzuw[]) Arrays.copyOf(zzuwArr2, zzuwArr2.length + zzuwArr.length);
            System.arraycopy(zzuwArr, 0, obj3, zzuwArr2.length, zzuwArr.length);
            obj = obj3;
            ...
            Object obj4 = (zzsk[]) Arrays.copyOf(zzskArr2, zzskArr2.length + zzskArr.length);
            System.arraycopy(zzskArr, 0, obj4, zzskArr2.length, zzskArr.length);
            obj = obj4;
        } else {

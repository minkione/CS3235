...
public final class zzh extends zzuq<zzh> {
    public zzl[] zzpe;
    public zzl[] zzpf;
    public C2263zzc[] zzpg;

    public zzh() {
        this.zzpe = zzl.zzaa();
        this.zzpf = zzl.zzaa();
        this.zzpg = new C2263zzc[0];
        this.zzbhb = null;
        this.zzbhl = -1;
    }
    ...
    public final void zza(zzuo zzuo) throws IOException {
        ...
        C2263zzc[] zzcArr = this.zzpg;
        if (zzcArr != null && zzcArr.length > 0) {
            while (true) {
                C2263zzc[] zzcArr2 = this.zzpg;
                if (i >= zzcArr2.length) {
                    break;
                }
                C2263zzc zzc = zzcArr2[i];
                if (zzc != null) {
                    zzuo.zze(3, (zzsk) zzc);
                }
                i++;
    ...
    public final /* synthetic */ zzuw zza(zzun zzun) throws IOException {
        while (true) {
            ...
            if (zzni == 10) {
                ...
                C2263zzc[] zzcArr2 = new C2263zzc[(zzb3 + length3)];
                if (length3 != 0) {
                    System.arraycopy(this.zzpg, 0, zzcArr2, 0, length3);
                }
                while (length3 < zzcArr2.length - 1) {
                    zzcArr2[length3] = (C2263zzc) zzun.zza(C2263zzc.zza());
                    zzun.zzni();
                    length3++;
                }
                zzcArr2[length3] = (C2263zzc) zzun.zza(C2263zzc.zza());

...
public final class zzm extends AbstractSafeParcelable {
    ...
    @Nullable
    @Field(defaultValueUnchecked = "null", mo9239id = 3)
    private String tag;
    @Field(defaultValueUnchecked = "DeviceOrientationRequestInternal.DEFAULT_DEVICE_ORIENTATION_REQUEST", mo9239id = 1)
    private zzj zzcf;
    @Field(defaultValueUnchecked = "DeviceOrientationRequestInternal.DEFAULT_CLIENTS", mo9239id = 2)
    private List<ClientIdentity> zzm;

    @Constructor
    zzm(@Param(mo9242id = 1) zzj zzj, @Param(mo9242id = 2) List<ClientIdentity> list, @Param(mo9242id = 3) String str) {
        this.zzcf = zzj;
        this.zzm = list;
        this.tag = str;
    }

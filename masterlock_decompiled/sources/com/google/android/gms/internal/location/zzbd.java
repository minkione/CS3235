...
public final class zzbd extends AbstractSafeParcelable {
    ...
    @Nullable
    @Field(defaultValueUnchecked = "null", mo9239id = 10)
    private String moduleId;
    @Nullable
    @Field(defaultValueUnchecked = "null", mo9239id = 6)
    private String tag;
    @Field(defaultValueUnchecked = "null", mo9239id = 1)
    private LocationRequest zzdg;
    @Field(defaultValueUnchecked = "LocationRequestInternal.DEFAULT_HIDE_FROM_APP_OPS", mo9239id = 7)
    private boolean zzdh;
    @Field(defaultValueUnchecked = "LocationRequestInternal.DEFAULT_FORCE_COARSE_LOCATION", mo9239id = 8)
    private boolean zzdi;
    @Field(defaultValueUnchecked = "LocationRequestInternal.DEFAULT_EXEMPT_FROM_THROTTLE", mo9239id = 9)
    private boolean zzdj;
    private boolean zzdk = true;
    @Field(defaultValueUnchecked = "LocationRequestInternal.DEFAULT_CLIENTS", mo9239id = 5)
    private List<ClientIdentity> zzm;

    @Constructor
    zzbd(@Param(mo9242id = 1) LocationRequest locationRequest, @Param(mo9242id = 5) List<ClientIdentity> list, @Nullable @Param(mo9242id = 6) String str, @Param(mo9242id = 7) boolean z, @Param(mo9242id = 8) boolean z2, @Param(mo9242id = 9) boolean z3, @Param(mo9242id = 10) String str2) {

...
import p009rx.subscriptions.RefCountSubscription;
            ...
            public void onCompleted() {
                ...
                if (this.once) {
                    ...
                    synchronized (ResultManager.this) {
                        observer = (Observer) ResultManager.this.leftMap().remove(Integer.valueOf(this.f244id));
                    }
                    if (observer != null) {
        ...
        final class RightDurationObserver extends Subscriber<D2> {
            ...
            public void onCompleted() {
                if (this.once) {
                    this.once = false;
                    synchronized (ResultManager.this) {
                        ResultManager.this.rightMap.remove(Integer.valueOf(this.f245id));
                    }
                    ResultManager.this.group.remove(this);
                }
            }

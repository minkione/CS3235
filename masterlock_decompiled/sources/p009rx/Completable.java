...
import p009rx.internal.operators.CompletableFromEmitter;
import p009rx.internal.operators.CompletableOnSubscribeConcat;
import p009rx.internal.operators.CompletableOnSubscribeConcatArray;
import p009rx.internal.operators.CompletableOnSubscribeConcatIterable;
import p009rx.internal.operators.CompletableOnSubscribeMerge;
import p009rx.internal.operators.CompletableOnSubscribeMergeArray;
import p009rx.internal.operators.CompletableOnSubscribeMergeDelayErrorArray;
import p009rx.internal.operators.CompletableOnSubscribeMergeDelayErrorIterable;
import p009rx.internal.operators.CompletableOnSubscribeMergeIterable;
import p009rx.internal.operators.CompletableOnSubscribeTimeout;
...
import p009rx.observers.SafeCompletableSubscriber;
...
import p009rx.subscriptions.MultipleAssignmentSubscription;
...
public class Completable {
    ...
    public static Completable amb(final Completable... completableArr) {
        ...
        return create(new OnSubscribe() {
            public void call(final CompletableSubscriber completableSubscriber) {
                ...
                C19361 r2 = new CompletableSubscriber() {
        ...
        return create(new OnSubscribe() {
            public void call(final CompletableSubscriber completableSubscriber) {
                ...
                try {
                    ...
                    final AtomicBoolean atomicBoolean = new AtomicBoolean();
                    C19491 r3 = new CompletableSubscriber() {
                        public void onCompleted() {
                            if (atomicBoolean.compareAndSet(false, true)) {
                                compositeSubscription.unsubscribe();
                                completableSubscriber.onCompleted();
    ...
    public static Completable fromObservable(final Observable<?> observable) {
        ...
        return create(new OnSubscribe() {
            public void call(final CompletableSubscriber completableSubscriber) {
                C18991 r0 = new Subscriber<Object>() {
    ...
    public static Completable fromSingle(final Single<?> single) {
        ...
        return create(new OnSubscribe() {
            public void call(final CompletableSubscriber completableSubscriber) {
                C19011 r0 = new SingleSubscriber<Object>() {
                    public void onError(Throwable th) {
                        completableSubscriber.onError(th);
                    }
                    ...
                    try {
                        ...
                        if (completable == null) {
                            try {
                                ...
                                completableSubscriber.onSubscribe(Subscriptions.unsubscribed());
                                completableSubscriber.onError(new CompositeException((Collection<? extends Throwable>) Arrays.asList(new Throwable[]{new NullPointerException("The completable supplied is null"), th})));
                            }
                        } else {
                            final AtomicBoolean atomicBoolean = new AtomicBoolean();
    ...
    public final Completable compose(Transformer transformer) {
        return (Completable) mo24750to(transformer);
    }
    ...
    /* renamed from: to */
    public final <R> R mo24750to(Func1<? super Completable, R> func1) {
        return func1.call(this);
    }

    public final <T> Observable<T> toObservable() {
        return Observable.unsafeCreate(new p009rx.Observable.OnSubscribe<T>() {
    ...
    public final <T> Single<T> toSingle(final Func0<? extends T> func0) {
        requireNonNull(func0);
        return Single.create(new p009rx.Single.OnSubscribe<T>() {
